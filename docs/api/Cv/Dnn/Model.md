...
## Methods
assign(arg_0: Cv::Dnn::Model) -> Cv::Dnn::Model

assign(arg_0: Cv::Dnn::Model) -> Cv::Dnn::Model

enable_winograd(use_winograd: [TrueClass](https://docs.ruby-lang.org/en/master/TrueClass.html)) -> Cv::Dnn::Model

get_impl -> Cv::Dnn::Model::Impl

get_impl_ref -> Cv::Dnn::Model::Impl

initialize_copy(arg_0: Cv::Dnn::Model) -> [NilClass](https://docs.ruby-lang.org/en/master/NilClass.html)
