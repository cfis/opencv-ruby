...
to_float -> [Float](https://docs.ruby-lang.org/en/master/Float.html)

to_int -> [Integer](https://docs.ruby-lang.org/en/master/Integer.html)

to_string -> [String](https://docs.ruby-lang.org/en/master/String.html)
