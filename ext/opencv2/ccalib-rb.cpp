...
void Init_Ccalib()
{
  ...
  Rice::Data_Type<cv::ccalib::CustomPattern> rb_cCvCcalibCustomPattern = define_class_under<cv::ccalib::CustomPattern, cv::Algorithm>(rb_mCvCcalib, "CustomPattern").
    ...
    define_method("create", &cv::ccalib::CustomPattern::create,
      Arg("pattern"), Arg("board_size"), Arg("output") = static_cast<cv::OutputArray>(cv::noArray())).
    define_method("find_pattern", &cv::ccalib::CustomPattern::findPattern,
    ...
    define_method("initialized?", &cv::ccalib::CustomPattern::isInitialized).
    define_method("get_pattern_points", &cv::ccalib::CustomPattern::getPatternPoints,
      Arg("original_points")).
    define_method("get_pixel_size", &cv::ccalib::CustomPattern::getPixelSize).
    define_method("set_feature_detector", &cv::ccalib::CustomPattern::setFeatureDetector,
      Arg("feature_detector")).
    define_method("set_descriptor_extractor", &cv::ccalib::CustomPattern::setDescriptorExtractor,
      Arg("extractor")).
    define_method("set_descriptor_matcher", &cv::ccalib::CustomPattern::setDescriptorMatcher,
      Arg("matcher")).
    define_method("get_feature_detector", &cv::ccalib::CustomPattern::getFeatureDetector).
    define_method("get_descriptor_extractor", &cv::ccalib::CustomPattern::getDescriptorExtractor).
    define_method("get_descriptor_matcher", &cv::ccalib::CustomPattern::getDescriptorMatcher).
    define_method("calibrate", &cv::ccalib::CustomPattern::calibrate,
      Arg("object_points"), Arg("image_points"), Arg("image_size"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvecs"), Arg("tvecs"), Arg("flags") = static_cast<int>(0), Arg("criteria") = static_cast<cv::TermCriteria>(cv::TermCriteria(cv::TermCriteria::COUNT + cv::TermCriteria::EPS, 30, DBL_EPSILON))).
    ...
    define_method("draw_orientation", &cv::ccalib::CustomPattern::drawOrientation,
