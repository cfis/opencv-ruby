...
void Init_Ccalib_Multicalib()
{
  ...
  Rice::Data_Type<cv::multicalib::MultiCameraCalibration> rb_cCvMulticalibMultiCameraCalibration = define_class_under<cv::multicalib::MultiCameraCalibration>(rb_mCvMulticalib, "MultiCameraCalibration")
    .define_constructor(Constructor<cv::multicalib::MultiCameraCalibration, int, int, const std::string&, float, float, int, int, int, int, cv::TermCriteria, cv::Ptr<cv::FeatureDetector>, cv::Ptr<cv::DescriptorExtractor>, cv::Ptr<cv::DescriptorMatcher>>(),
      Arg("camera_type"), Arg("n_cameras"), Arg("file_name"), Arg("pattern_width"), Arg("pattern_height"), Arg("verbose") = static_cast<int>(0), Arg("show_extration") = static_cast<int>(0), Arg("n_mini_matches") = static_cast<int>(20), Arg("flags") = static_cast<int>(0), Arg("criteria") = static_cast<cv::TermCriteria>(cv::TermCriteria(cv::TermCriteria::Type::COUNT + cv::TermCriteria::Type::EPS, 200, 1e-7)), Arg("detector") = static_cast<cv::Ptr<cv::FeatureDetector>>(cv::AKAZE::create(cv::AKAZE::DescriptorType::DESCRIPTOR_MLDB, 0, 3, 0.006f)), Arg("descriptor") = static_cast<cv::Ptr<cv::DescriptorExtractor>>(cv::AKAZE::create(cv::AKAZE::DescriptorType::DESCRIPTOR_MLDB,0, 3, 0.006f)), Arg("matcher") = static_cast<cv::Ptr<cv::DescriptorMatcher>>(cv::DescriptorMatcher::create("BruteForce-L1")))
