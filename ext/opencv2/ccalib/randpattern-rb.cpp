...
void Init_Ccalib_Randpattern()
{
  ...
  Rice::Data_Type<cv::randpattern::RandomPatternCornerFinder> rb_cCvRandpatternRandomPatternCornerFinder = define_class_under<cv::randpattern::RandomPatternCornerFinder>(rb_mCvRandpattern, "RandomPatternCornerFinder")
    .define_constructor(Constructor<cv::randpattern::RandomPatternCornerFinder, float, float, int, int, int, int, cv::Ptr<cv::FeatureDetector>, cv::Ptr<cv::DescriptorExtractor>, cv::Ptr<cv::DescriptorMatcher>>(),
      Arg("pattern_width"), Arg("pattern_height"), Arg("nmini_match") = static_cast<int>(20), Arg("depth") = static_cast<int>(CV_32F), Arg("verbose") = static_cast<int>(0), Arg("show_extraction") = static_cast<int>(0), Arg("detector") = static_cast<cv::Ptr<cv::FeatureDetector>>(cv::AKAZE::create(cv::AKAZE::DescriptorType::DESCRIPTOR_MLDB, 0, 3, 0.005f)), Arg("descriptor") = static_cast<cv::Ptr<cv::DescriptorExtractor>>(cv::AKAZE::create(cv::AKAZE::DescriptorType::DESCRIPTOR_MLDB,0, 3, 0.005f)), Arg("matcher") = static_cast<cv::Ptr<cv::DescriptorMatcher>>(cv::DescriptorMatcher::create("BruteForce-L1")))
