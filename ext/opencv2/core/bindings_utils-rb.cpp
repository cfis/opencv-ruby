...
void Init_Core_BindingsUtils()
{
  ...
  rb_mCvUtils.define_module_function<cv::String(*)(const std::vector<cv::Rect>&)>("dump_vector_of_rect", &cv::utils::dumpVectorOfRect,
    Arg("vec"));
  ...
  rb_mCvUtils.define_module_function<void(*)(size_t, std::vector<cv::Rect>&)>("generate_vector_of_rect", &cv::utils::generateVectorOfRect,
    Arg("len"), Arg("vec"));
