...
#include "../../opencv_ruby_version.hpp" // Manaul
#include "cvstd_wrapper-rb.hpp" // Manaul
#include "cuda-rb.hpp"
...
Data_Type<cv::cuda::GpuMat> rb_cCvCudaGpuMat;
...
void Init_Cuda()
{
  ...
  rb_cCvCudaDeviceInfo = define_class_under<cv::cuda::DeviceInfo>(rb_mCvCuda, "DeviceInfo").
    ...
    define_method("max_texture2_d", &cv::cuda::DeviceInfo::maxTexture2D).
    ...
    define_method("max_surface2_d", &cv::cuda::DeviceInfo::maxSurface2D).
  ...
  //error LNK2019 : unresolved external symbol "void __cdecl cv::cuda::convertFp16(class cv::debug_build_guard::_InputArray const &,class cv::debug_build_guard::_OutputArray const &,class cv::cuda::Stream &)" (? convertFp16@cuda@cv@@YAXAEBV_InputArray@debug_build_guard@2@AEBV_OutputArray@42@AEAVStream@12@@Z) referenced in function "void __cdecl Init_Cuda(void)" (? Init_Cuda@@YAXXZ)
