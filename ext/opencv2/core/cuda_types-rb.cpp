...
Rice::Class rb_cDevPtrFloat;
Rice::Class rb_cDevPtrInt;
Rice::Class rb_cDevPtrUnsignedChar;
Rice::Class rb_cDevPtrUnsignedShort;
...
void Init_CudaTypes()
{
  ...
  rb_cDevPtrUnsignedChar = define_class_under<cv::cuda::DevPtr<unsigned char>>(rb_mCvCuda, "DevPtrUnsignedChar").
  ...
  rb_cDevPtrUnsignedShort = define_class_under<cv::cuda::DevPtr<unsigned short>>(rb_mCvCuda, "DevPtrUnsignedShort").
  ...
  rb_cDevPtrFloat = define_class_under<cv::cuda::DevPtr<float>>(rb_mCvCuda, "DevPtrFloat").
  ...
  rb_cDevPtrInt = define_class_under<cv::cuda::DevPtr<int>>(rb_mCvCuda, "DevPtrInt").
