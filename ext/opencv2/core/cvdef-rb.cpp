...
void Init_Core_Cvdef()
{
  ...
  Rice::Data_Type<Cv16suf> cv16suf = define_class<Cv16suf>("Cv16suf")
    .define_attr("i", &Cv16suf::i)
    .define_attr("u", &Cv16suf::u);

  Rice::Data_Type<Cv32suf> cv32suf = define_class<Cv32suf>("Cv32suf")
    .define_attr("i", &Cv32suf::i)
    .define_attr("u", &Cv32suf::u)
    .define_attr("f", &Cv32suf::f);

  Rice::Data_Type<Cv64suf> cv64suf = define_class<Cv64suf>("Cv64suf")
