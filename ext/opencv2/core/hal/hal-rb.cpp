...
void Init_Hal()
{
  ...
  rb_mCvHal.define_module_function("add8u", &cv::hal::add8u,
    Arg("src1"), Arg("step1"), Arg("src2"), Arg("step2"), Arg("dst"), Arg("step"), Arg("width"), Arg("height"));
  ...
  rb_mCvHal.define_module_function("recip8u", &cv::hal::recip8u,
    Arg("arg_0"), Arg("arg_1"), Arg("src2"), Arg("step2"), Arg("dst"), Arg("step"), Arg("width"), Arg("height"), Arg("scale"));
