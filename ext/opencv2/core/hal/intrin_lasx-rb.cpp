...
void Init_IntrinLasx()
{
  ...
  rb_mCv.define_module_function("_v256_set_b", &cv::_v256_set_b,
  ...
  rb_mCv.define_module_function("_v256_setr_h", &cv::_v256_setr_h,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"), Arg("v10"), Arg("v11"), Arg("v12"), Arg("v13"), Arg("v14"), Arg("v15"));

  rb_mCv.define_module_function("_v256_setr_w", &cv::_v256_setr_w,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"));

  rb_mCv.define_module_function("_v256_set_w", &cv::_v256_set_w,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"));

  rb_mCv.define_module_function("_v256_setall_w", &cv::_v256_setall_w,
    Arg("v0"));

  rb_mCv.define_module_function("_v256_setr_d", &cv::_v256_setr_d,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));

  rb_mCv.define_module_function("_v256_set_d", &cv::_v256_set_d,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));

  rb_mCv.define_module_function("_v256_setr_ps", &cv::_v256_setr_ps,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"));

  rb_mCv.define_module_function("_v256_setall_ps", &cv::_v256_setall_ps,
    Arg("f32"));

  rb_mCv.define_module_function("_v256_setr_pd", &cv::_v256_setr_pd,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));

  rb_mCv.define_module_function("_v256_setall_pd", &cv::_v256_setall_pd,
    Arg("f64"));

  rb_mCv.define_module_function("_lasx_packus_h", &cv::_lasx_packus_h,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function("_lasx_packs_h", &cv::_lasx_packs_h,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function("_lasx_packus_w", &cv::_lasx_packus_w,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function("_lasx_packs_w", &cv::_lasx_packs_w,
    Arg("a"), Arg("b"));
  ...
  rb_cCvVFloat32x8 = define_class_under<cv::v_float32x8>(rb_mCv, "VFloat32x8").
    ...
    define_method("get0toint", &cv::v_float32x8::get0toint);
  ...
  rb_cCvVFloat64x4 = define_class_under<cv::v_float64x4>(rb_mCv, "VFloat64x4").
    ...
    define_method("get0toint64", &cv::v_float64x4::get0toint64);

  rb_cCvVFloat64x4.define_constant("Nlanes", (int)cv::v_float64x4::nlanes);

  rb_mCv.define_module_function("_lasx_256_castps_si256", &cv::_lasx_256_castps_si256,
    Arg("v"));

  rb_mCv.define_module_function("_lasx_256_castpd_si256", &cv::_lasx_256_castpd_si256,
    Arg("v"));

  rb_mCv.define_module_function("_lasx_256_castsi256_ps", &cv::_lasx_256_castsi256_ps,
    Arg("v"));

  rb_mCv.define_module_function("_lasx_256_castsi256_pd", &cv::_lasx_256_castsi256_pd,
    Arg("v"));
  ...
  rb_mCv.define_module_function("_v256_alignr_b", &cv::_v256_alignr_b,
    Arg("a"), Arg("b"), Arg("imm"));
  ...
  rb_mCv.define_module_function<cv::v_float32x8(*)(const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&)>("v_select", &cv::v_select,
    Arg("mask"), Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::v_float64x4(*)(const cv::v_float64x4&, const cv::v_float64x4&, const cv::v_float64x4&)>("v_select", &cv::v_select,
    Arg("mask"), Arg("a"), Arg("b"));

  rb_cCvVFloat32x8.define_method(">", [](const cv::v_float32x8& self, const cv::v_float32x8& other) -> cv::v_float32x8
  {
    return self > other;
  });
  ...
  rb_cCvVFloat64x4.define_method(">", [](const cv::v_float64x4& self, const cv::v_float64x4& other) -> cv::v_float64x4
  {
    return self > other;
  });
  ...
  rb_mCv.define_module_function<void(*)(const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&, cv::v_float32x8&, cv::v_float32x8&, cv::v_float32x8&, cv::v_float32x8&)>("v_transpose4x4", &cv::v_transpose4x4,
  ...
  rb_mCv.define_module_function<void(*)(int*, const cv::v_uint8x32&, const cv::v_uint8x32&, int)>("v_store_interleave", &cv::v_store_interleave,
    Arg("ptr"), Arg("x"), Arg("y"), Arg("arg_3") = static_cast<int>());
  ...
  rb_mCv.define_module_function<void(*)(int*, const cv::v_uint8x32&, const cv::v_uint8x32&, const cv::v_uint8x32&, int)>("v_store_interleave", &cv::v_store_interleave,
    Arg("ptr"), Arg("a"), Arg("b"), Arg("c"), Arg("arg_4") = static_cast<int>());
  ...
  rb_mCv.define_module_function<void(*)(int*, const cv::v_uint8x32&, const cv::v_uint8x32&, const cv::v_uint8x32&, const cv::v_uint8x32&, int)>("v_store_interleave", &cv::v_store_interleave,
    Arg("ptr"), Arg("a"), Arg("b"), Arg("c"), Arg("d"), Arg("arg_5") = static_cast<int>());
