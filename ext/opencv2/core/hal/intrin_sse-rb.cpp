...
void Init_IntrinSse()
{
  ...
  rb_cCvVUint8x16 = define_class_under<cv::v_uint8x16>(rb_mCv, "VUint8x16").
    ...
    define_constructor(Constructor<cv::v_uint8x16, __m128i>(),
      Arg("v")).
  ...
  rb_cCvVInt8x16 = define_class_under<cv::v_int8x16>(rb_mCv, "VInt8x16").
    ...
    define_constructor(Constructor<cv::v_int8x16, __m128i>(),
      Arg("v")).
  ...
  rb_cCvVUint16x8 = define_class_under<cv::v_uint16x8>(rb_mCv, "VUint16x8").
    ...
    define_constructor(Constructor<cv::v_uint16x8, __m128i>(),
      Arg("v")).
  ...
  rb_cCvVInt16x8 = define_class_under<cv::v_int16x8>(rb_mCv, "VInt16x8").
    ...
    define_constructor(Constructor<cv::v_int16x8, __m128i>(),
      Arg("v")).
  ...
  rb_cCvVUint32x4 = define_class_under<cv::v_uint32x4>(rb_mCv, "VUint32x4").
    ...
    define_constructor(Constructor<cv::v_uint32x4, __m128i>(),
      Arg("v")).
  ...
  rb_cCvVInt32x4 = define_class_under<cv::v_int32x4>(rb_mCv, "VInt32x4").
    ...
    define_constructor(Constructor<cv::v_int32x4, __m128i>(),
      Arg("v")).
  ...
  rb_cCvVFloat32x4 = define_class_under<cv::v_float32x4>(rb_mCv, "VFloat32x4").
    ...
    define_constructor(Constructor<cv::v_float32x4, __m128>(),
      Arg("v")).
  ...
  rb_cCvVUint64x2 = define_class_under<cv::v_uint64x2>(rb_mCv, "VUint64x2").
    ...
    define_constructor(Constructor<cv::v_uint64x2, __m128i>(),
      Arg("v")).
  ...
  rb_cCvVInt64x2 = define_class_under<cv::v_int64x2>(rb_mCv, "VInt64x2").
    ...
    define_constructor(Constructor<cv::v_int64x2, __m128i>(),
      Arg("v")).
  ...
  rb_cCvVFloat64x2 = define_class_under<cv::v_float64x2>(rb_mCv, "VFloat64x2").
    ...
    define_constructor(Constructor<cv::v_float64x2, __m128d>(),
      Arg("v")).
  ...
  rb_mCv.define_module_function("v_setzero_u64", &cv::v_setzero_u64);

  rb_mCv.define_module_function("v_setzero_s64", &cv::v_setzero_s64);

  rb_mCv.define_module_function("v_setall_u64", &cv::v_setall_u64,
    Arg("val"));

  rb_mCv.define_module_function("v_setall_s64", &cv::v_setall_s64,
    Arg("val"));
  ...
  rb_mCv.define_module_function("v_select_si128", &cv::v_select_si128,
  ...
  rb_mCv.define_module_function("v_sign_epi64", &cv::v_sign_epi64,
    Arg("a"));

  rb_mCv.define_module_function("v_srai_epi64", &cv::v_srai_epi64,
    Arg("a"), Arg("imm"));
  ...
  rb_mCv.define_module_function<cv::v_uint32x4(*)(const cv::v_int32x4&)>("v_abs", &cv::v_abs,
    Arg("x"));
  ...
  rb_mCv.define_module_function<cv::v_int8x16(*)(const cv::v_int8x16&, const cv::v_int8x16&)>("v_min", &cv::v_min,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::v_int8x16(*)(const cv::v_int8x16&, const cv::v_int8x16&)>("v_max", &cv::v_max,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::v_uint16x8(*)(const cv::v_uint16x8&, const cv::v_uint16x8&)>("v_min", &cv::v_min,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::v_uint16x8(*)(const cv::v_uint16x8&, const cv::v_uint16x8&)>("v_max", &cv::v_max,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::v_uint32x4(*)(const cv::v_uint32x4&, const cv::v_uint32x4&)>("v_min", &cv::v_min,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::v_uint32x4(*)(const cv::v_uint32x4&, const cv::v_uint32x4&)>("v_max", &cv::v_max,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::v_int32x4(*)(const cv::v_int32x4&, const cv::v_int32x4&)>("v_min", &cv::v_min,
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::v_int32x4(*)(const cv::v_int32x4&, const cv::v_int32x4&)>("v_max", &cv::v_max,
    Arg("a"), Arg("b"));
  ...
  rb_mCv.define_module_function<void(*)(uchar*, const cv::v_uint8x16&, const cv::v_uint8x16&, int)>("v_store_interleave", &cv::v_store_interleave,
    Arg("ptr"), Arg("a"), Arg("b"), Arg("mode") = static_cast<int>());
