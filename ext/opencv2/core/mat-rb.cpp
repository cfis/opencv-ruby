...
void Init_Core_Mat()
{
  ...
  Rice::Data_Type<cv::_OutputArray> rb_cCvOutputArray = define_class_under<cv::_OutputArray, cv::_InputArray>(rb_mCv, "OutputArray")
    ...
    .define_method<void(cv::_OutputArray::*)(cv::Size, int, int, bool, cv::_OutputArray::DepthMask) const>("create", &cv::_OutputArray::create,
      Arg("sz"), Arg("type"), Arg("i") = static_cast<int>(-1), Arg("allow_transposed") = static_cast<bool>(false), Arg("fixed_depth_mask") = static_cast<cv::_OutputArray::DepthMask>(static_cast<cv::_OutputArray::DepthMaskMask>(0)))
    .define_method<void(cv::_OutputArray::*)(int, int, int, int, bool, cv::_OutputArray::DepthMask) const>("create", &cv::_OutputArray::create,
      Arg("rows"), Arg("cols"), Arg("type"), Arg("i") = static_cast<int>(-1), Arg("allow_transposed") = static_cast<bool>(false), Arg("fixed_depth_mask") = static_cast<cv::_OutputArray::DepthMask>(static_cast<cv::_OutputArray::DepthMaskMask>(0)))
    .define_method<void(cv::_OutputArray::*)(int, const int *, int, int, bool, cv::_OutputArray::DepthMask) const>("create", &cv::_OutputArray::create,
      Arg("dims"), ArgBuffer("size"), Arg("type"), Arg("i") = static_cast<int>(-1), Arg("allow_transposed") = static_cast<bool>(false), Arg("fixed_depth_mask") = static_cast<cv::_OutputArray::DepthMask>(static_cast<cv::_OutputArray::DepthMaskMask>(0)))
  ...
  Rice::Data_Type<cv::SparseMat> rb_cCvSparseMat = define_class_under<cv::SparseMat>(rb_mCv, "SparseMat")
    ...
    // Manual - Commented out SparseMat define_iterator - SparseMatIterator doesn't dereference like standard iterators
