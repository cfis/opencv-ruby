...
void Init_Core_Mat()
{
  ...
  Rice::Data_Type<cv::_OutputArray> rb_cCvOutputArray = define_class_under<cv::_OutputArray, cv::_InputArray>(rb_mCv, "OutputArray")
    ...
    .define_method<void(cv::_OutputArray::*)(int, const int *, int, int, bool, cv::_OutputArray::DepthMask) const>("create", &cv::_OutputArray::create,
      Arg("dims"), ArgBuffer("size"), Arg("type"), Arg("i") = static_cast<int>(-1), Arg("allow_transposed") = static_cast<bool>(false), Arg("fixed_depth_mask") = static_cast<cv::_OutputArray::DepthMask>(static_cast<cv::_OutputArray::DepthMask>(0)))
  ...
  Rice::Data_Type<cv::MatSize> rb_cCvMatSize = define_class_under<cv::MatSize>(rb_mCv, "MatSize")
    ...
    .define_method<int &(cv::MatSize::*)(int)>("[]", &cv::MatSize::operator[],
      Arg("i"))
    .define_method("[]=", [](cv::MatSize&self, int i, int & value)
    {
        self[i] = value;
    })
  ...
  Rice::Data_Type<cv::MatStep> rb_cCvMatStep = define_class_under<cv::MatStep>(rb_mCv, "MatStep")
    ...
    .define_method<size_t &(cv::MatStep::*)(int) noexcept>("[]", &cv::MatStep::operator[],
      Arg("i"))
    .define_method("[]=", [](cv::MatStep&self, int i, size_t & value)
    {
        self[i] = value;
    })
  ...
  Rice::Data_Type<cv::Mat> rb_cCvMat = define_class_under<cv::Mat>(rb_mCv, "Mat")
    ...
    .define_singleton_function<cv::Mat(*)(const cv::Mat &)>("diag", static_cast<cv::Mat(*)(const cv::Mat &)>(&cv::Mat::diag),
      Arg("d"))
    ...
    .define_method<double(cv::Mat::*)(cv::InputArray) const>("dot", &cv::Mat::dot,
      Arg("m"))
    .define_singleton_function<cv::MatExpr(*)(int, int, int)>("zeros", static_cast<cv::MatExpr(*)(int, int, int)>(&cv::Mat::zeros),
      Arg("rows"), Arg("cols"), Arg("type"))
    .define_singleton_function<cv::MatExpr(*)(cv::Size, int)>("zeros", static_cast<cv::MatExpr(*)(cv::Size, int)>(&cv::Mat::zeros),
      Arg("size"), Arg("type"))
    .define_singleton_function<cv::MatExpr(*)(int, const int *, int)>("zeros", static_cast<cv::MatExpr(*)(int, const int *, int)>(&cv::Mat::zeros),
      Arg("ndims"), ArgBuffer("sz"), Arg("type"))
    .define_singleton_function<cv::MatExpr(*)(int, int, int)>("ones", static_cast<cv::MatExpr(*)(int, int, int)>(&cv::Mat::ones),
      Arg("rows"), Arg("cols"), Arg("type"))
    .define_singleton_function<cv::MatExpr(*)(cv::Size, int)>("ones", static_cast<cv::MatExpr(*)(cv::Size, int)>(&cv::Mat::ones),
      Arg("size"), Arg("type"))
    .define_singleton_function<cv::MatExpr(*)(int, const int *, int)>("ones", static_cast<cv::MatExpr(*)(int, const int *, int)>(&cv::Mat::ones),
      Arg("ndims"), ArgBuffer("sz"), Arg("type"))
    .define_singleton_function<cv::MatExpr(*)(int, int, int)>("eye", static_cast<cv::MatExpr(*)(int, int, int)>(&cv::Mat::eye),
      Arg("rows"), Arg("cols"), Arg("type"))
    .define_singleton_function<cv::MatExpr(*)(cv::Size, int)>("eye", static_cast<cv::MatExpr(*)(cv::Size, int)>(&cv::Mat::eye),
      Arg("size"), Arg("type"))
  ...
  Rice::Data_Type<cv::Mat_<unsigned char>> rb_cMat1b = Mat__instantiate<unsigned char>(rb_mCv, "Mat1b");
  ...
  Rice::Data_Type<cv::Mat_<unsigned short>> rb_cMat1w = Mat__instantiate<unsigned short>(rb_mCv, "Mat1w");
  ...
  Rice::Data_Type<cv::UMat> rb_cCvUMat = define_class_under<cv::UMat>(rb_mCv, "UMat")
    ...
    .define_method<cv::UMat(cv::UMat::*)(int) const>("diag", &cv::UMat::diag,
      Arg("d") = static_cast<int>(0))
    .define_singleton_function<cv::UMat(*)(const cv::UMat &, cv::UMatUsageFlags)>("diag", static_cast<cv::UMat(*)(const cv::UMat &, cv::UMatUsageFlags)>(&cv::UMat::diag),
      Arg("d"), Arg("usage_flags"))
    .define_singleton_function<cv::UMat(*)(const cv::UMat &)>("diag", static_cast<cv::UMat(*)(const cv::UMat &)>(&cv::UMat::diag),
      Arg("d"))
    ...
    .define_method<double(cv::UMat::*)(cv::InputArray) const>("dot", &cv::UMat::dot,
      Arg("m"))
    .define_singleton_function<cv::UMat(*)(int, int, int, cv::UMatUsageFlags)>("zeros", static_cast<cv::UMat(*)(int, int, int, cv::UMatUsageFlags)>(&cv::UMat::zeros),
      Arg("rows"), Arg("cols"), Arg("type"), Arg("usage_flags"))
    .define_singleton_function<cv::UMat(*)(cv::Size, int, cv::UMatUsageFlags)>("zeros", static_cast<cv::UMat(*)(cv::Size, int, cv::UMatUsageFlags)>(&cv::UMat::zeros),
      Arg("size"), Arg("type"), Arg("usage_flags"))
    .define_singleton_function<cv::UMat(*)(int, const int *, int, cv::UMatUsageFlags)>("zeros", static_cast<cv::UMat(*)(int, const int *, int, cv::UMatUsageFlags)>(&cv::UMat::zeros),
      Arg("ndims"), ArgBuffer("sz"), Arg("type"), Arg("usage_flags"))
    .define_singleton_function<cv::UMat(*)(int, int, int)>("zeros", static_cast<cv::UMat(*)(int, int, int)>(&cv::UMat::zeros),
      Arg("rows"), Arg("cols"), Arg("type"))
    .define_singleton_function<cv::UMat(*)(cv::Size, int)>("zeros", static_cast<cv::UMat(*)(cv::Size, int)>(&cv::UMat::zeros),
      Arg("size"), Arg("type"))
    .define_singleton_function<cv::UMat(*)(int, const int *, int)>("zeros", static_cast<cv::UMat(*)(int, const int *, int)>(&cv::UMat::zeros),
      Arg("ndims"), ArgBuffer("sz"), Arg("type"))
    .define_singleton_function<cv::UMat(*)(int, int, int, cv::UMatUsageFlags)>("ones", static_cast<cv::UMat(*)(int, int, int, cv::UMatUsageFlags)>(&cv::UMat::ones),
      Arg("rows"), Arg("cols"), Arg("type"), Arg("usage_flags"))
    .define_singleton_function<cv::UMat(*)(cv::Size, int, cv::UMatUsageFlags)>("ones", static_cast<cv::UMat(*)(cv::Size, int, cv::UMatUsageFlags)>(&cv::UMat::ones),
      Arg("size"), Arg("type"), Arg("usage_flags"))
    .define_singleton_function<cv::UMat(*)(int, const int *, int, cv::UMatUsageFlags)>("ones", static_cast<cv::UMat(*)(int, const int *, int, cv::UMatUsageFlags)>(&cv::UMat::ones),
      Arg("ndims"), ArgBuffer("sz"), Arg("type"), Arg("usage_flags"))
    .define_singleton_function<cv::UMat(*)(int, int, int)>("ones", static_cast<cv::UMat(*)(int, int, int)>(&cv::UMat::ones),
      Arg("rows"), Arg("cols"), Arg("type"))
    .define_singleton_function<cv::UMat(*)(cv::Size, int)>("ones", static_cast<cv::UMat(*)(cv::Size, int)>(&cv::UMat::ones),
      Arg("size"), Arg("type"))
    .define_singleton_function<cv::UMat(*)(int, const int *, int)>("ones", static_cast<cv::UMat(*)(int, const int *, int)>(&cv::UMat::ones),
      Arg("ndims"), ArgBuffer("sz"), Arg("type"))
    .define_singleton_function<cv::UMat(*)(int, int, int, cv::UMatUsageFlags)>("eye", static_cast<cv::UMat(*)(int, int, int, cv::UMatUsageFlags)>(&cv::UMat::eye),
      Arg("rows"), Arg("cols"), Arg("type"), Arg("usage_flags"))
    .define_singleton_function<cv::UMat(*)(cv::Size, int, cv::UMatUsageFlags)>("eye", static_cast<cv::UMat(*)(cv::Size, int, cv::UMatUsageFlags)>(&cv::UMat::eye),
      Arg("size"), Arg("type"), Arg("usage_flags"))
    .define_singleton_function<cv::UMat(*)(int, int, int)>("eye", static_cast<cv::UMat(*)(int, int, int)>(&cv::UMat::eye),
      Arg("rows"), Arg("cols"), Arg("type"))
    .define_singleton_function<cv::UMat(*)(cv::Size, int)>("eye", static_cast<cv::UMat(*)(cv::Size, int)>(&cv::UMat::eye),
      Arg("size"), Arg("type"))
  ...
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat &, const cv::Mat &)>("min", static_cast<cv::MatExpr(*)(const cv::Mat &, const cv::Mat &)>(&cv::min),
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat &, double)>("min", static_cast<cv::MatExpr(*)(const cv::Mat &, double)>(&cv::min),
    Arg("a"), Arg("s"));

  rb_mCv.define_module_function<cv::MatExpr(*)(double, const cv::Mat &)>("min", static_cast<cv::MatExpr(*)(double, const cv::Mat &)>(&cv::min),
    Arg("s"), Arg("a"));

  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat &, const cv::Mat &)>("max", static_cast<cv::MatExpr(*)(const cv::Mat &, const cv::Mat &)>(&cv::max),
    Arg("a"), Arg("b"));

  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat &, double)>("max", static_cast<cv::MatExpr(*)(const cv::Mat &, double)>(&cv::max),
    Arg("a"), Arg("s"));

  rb_mCv.define_module_function<cv::MatExpr(*)(double, const cv::Mat &)>("max", static_cast<cv::MatExpr(*)(double, const cv::Mat &)>(&cv::max),
    Arg("s"), Arg("a"));

  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat &)>("abs", static_cast<cv::MatExpr(*)(const cv::Mat &)>(&cv::abs),
    Arg("m"));

  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::MatExpr &)>("abs", static_cast<cv::MatExpr(*)(const cv::MatExpr &)>(&cv::abs),
    Arg("e"));
