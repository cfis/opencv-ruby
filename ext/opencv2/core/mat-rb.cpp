...
void Init_Core_Mat()
{
  ...
  Rice::Data_Type<cv::Mat_<cv::Vec<uchar, 2>>> rb_cMat2b = Mat__instantiate<cv::Vec<unsigned char, 2>>(rb_mCv, "Mat2b");

  Rice::Data_Type<cv::Mat_<cv::Vec<uchar, 3>>> rb_cMat3b = Mat__instantiate<cv::Vec<unsigned char, 3>>(rb_mCv, "Mat3b");

  Rice::Data_Type<cv::Mat_<cv::Vec<uchar, 4>>> rb_cMat4b = Mat__instantiate<cv::Vec<unsigned char, 4>>(rb_mCv, "Mat4b");
  ...
  Rice::Data_Type<cv::Mat_<cv::Vec<ushort, 2>>> rb_cMat2w = Mat__instantiate<cv::Vec<unsigned short, 2>>(rb_mCv, "Mat2w");

  Rice::Data_Type<cv::Mat_<cv::Vec<ushort, 3>>> rb_cMat3w = Mat__instantiate<cv::Vec<unsigned short, 3>>(rb_mCv, "Mat3w");

  Rice::Data_Type<cv::Mat_<cv::Vec<ushort, 4>>> rb_cMat4w = Mat__instantiate<cv::Vec<unsigned short, 4>>(rb_mCv, "Mat4w");
  ...
  Rice::Data_Type<cv::SparseMat> rb_cCvSparseMat = define_class_under<cv::SparseMat>(rb_mCv, "SparseMat")
    ...
    // Manual: Commented out - SparseMatIterator doesn't dereference like standard iterators, use SparseMat__Refinements instead
