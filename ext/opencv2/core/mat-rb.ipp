...
{
  return Rice::define_class_under<cv::Mat_<_Tp>, cv::Mat>(parent, name). // Manual - Mat_ inherits from Mat
    ...
    template define_method<cv::Mat_<_Tp>(cv::Mat_<_Tp>::*)(const cv::Range&, const cv::Range&) const>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("row_range"), Arg("col_range")).
    template define_method<cv::Mat_<_Tp>(cv::Mat_<_Tp>::*)(const cv::Rect&) const>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("roi")).
    template define_method<cv::Mat_<_Tp>(cv::Mat_<_Tp>::*)(const cv::Range*) const>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("ranges")).
    template define_method<cv::Mat_<_Tp>(cv::Mat_<_Tp>::*)(const std::vector<cv::Range>&) const>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("ranges")).
    ...
    template define_method<const _Tp*(cv::Mat_<_Tp>::*)(int) const>("[]", &cv::Mat_<_Tp>::operator[],
      Arg("y")).
    template define_method<_Tp&(cv::Mat_<_Tp>::*)(const int*)>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      ArgBuffer("idx")).
    template define_method<const _Tp&(cv::Mat_<_Tp>::*)(const int*) const>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      ArgBuffer("idx")).
    template define_method<_Tp&(cv::Mat_<_Tp>::*)(int)>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("idx0")).
    template define_method<const _Tp&(cv::Mat_<_Tp>::*)(int) const>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("idx0")).
    template define_method<_Tp&(cv::Mat_<_Tp>::*)(int, int)>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("row"), Arg("col")).
    template define_method<const _Tp&(cv::Mat_<_Tp>::*)(int, int) const>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("row"), Arg("col")).
    template define_method<_Tp&(cv::Mat_<_Tp>::*)(int, int, int)>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("idx0"), Arg("idx1"), Arg("idx2")).
    template define_method<const _Tp&(cv::Mat_<_Tp>::*)(int, int, int) const>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("idx0"), Arg("idx1"), Arg("idx2")).
    template define_method<_Tp&(cv::Mat_<_Tp>::*)(cv::Point)>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("pt")).
    template define_method<const _Tp&(cv::Mat_<_Tp>::*)(cv::Point) const>("[]", &cv::Mat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("pt")).
...
{
  return Rice::define_class_under<cv::SparseMat_<_Tp>, cv::SparseMat>(parent, name). // Manual - SparseMat_ inherits from SparseMat
    ...
    template define_method<_Tp(cv::SparseMat_<_Tp>::*)(int, size_t*) const>("[]", &cv::SparseMat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("i0"), ArgBuffer("hashval") = static_cast<size_t*>(0)).
    template define_method<_Tp(cv::SparseMat_<_Tp>::*)(int, int, size_t*) const>("[]", &cv::SparseMat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("i0"), Arg("i1"), ArgBuffer("hashval") = static_cast<size_t*>(0)).
    template define_method<_Tp(cv::SparseMat_<_Tp>::*)(int, int, int, size_t*) const>("[]", &cv::SparseMat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      Arg("i0"), Arg("i1"), Arg("i2"), ArgBuffer("hashval") = static_cast<size_t*>(0)).
    template define_method<_Tp(cv::SparseMat_<_Tp>::*)(const int*, size_t*) const>("[]", &cv::SparseMat_<_Tp>::operator(), // Manual - renamed from "call" to "[]"
      ArgBuffer("idx"), ArgBuffer("hashval") = static_cast<size_t*>(0)).
...
{
  return Rice::define_class_under<cv::MatConstIterator_<_Tp>, cv::MatConstIterator>(parent, name). // Manual - MatConstIterator_ inherits from MatConstIterator
...
{
  return Rice::define_class_under<cv::MatIterator_<_Tp>, cv::MatConstIterator_<_Tp>>(parent, name). // Manual - MatIterator_ inherits from MatConstIterator_
...
{
  return Rice::define_class_under<cv::SparseMatConstIterator_<_Tp>, cv::SparseMatConstIterator>(parent, name). // Manual - SparseMatConstIterator_ inherits from SparseMatConstIterator
...
{
  return Rice::define_class_under<cv::SparseMatIterator_<_Tp>, cv::SparseMatConstIterator_<_Tp>>(parent, name). // Manual - SparseMatIterator_ inherits from SparseMatConstIterator_
