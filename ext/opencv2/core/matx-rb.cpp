...
void Init_Core_Matx()
{
  ...
  Rice::Data_Type<cv::Vec<unsigned char, 2>> rb_cVec2b = Vec_instantiate<unsigned char, 2>(rb_mCv, "Vec2b");

  Rice::Data_Type<cv::Matx<unsigned char, 3, 1>> rb_cMatx31b = Matx_instantiate<unsigned char, 3, 1>(rb_mCv, "Matx31b");
  Rice::Data_Type<cv::Vec<unsigned char, 3>> rb_cVec3b = Vec_instantiate<unsigned char, 3>(rb_mCv, "Vec3b");

  Rice::Data_Type<cv::Matx<unsigned char, 4, 1>> rb_cMatx41b = Matx_instantiate<unsigned char, 4, 1>(rb_mCv, "Matx41b");
  Rice::Data_Type<cv::Vec<unsigned char, 4>> rb_cVec4b = Vec_instantiate<unsigned char, 4>(rb_mCv, "Vec4b");
  ...
  Rice::Data_Type<cv::Vec<unsigned short, 2>> rb_cVec2w = Vec_instantiate<unsigned short, 2>(rb_mCv, "Vec2w");

  Rice::Data_Type<cv::Matx<unsigned short, 3, 1>> rb_cMatx31w = Matx_instantiate<unsigned short, 3, 1>(rb_mCv, "Matx31w");
  Rice::Data_Type<cv::Vec<unsigned short, 3>> rb_cVec3w = Vec_instantiate<unsigned short, 3>(rb_mCv, "Vec3w");

  Rice::Data_Type<cv::Matx<unsigned short, 4, 1>> rb_cMatx41w = Matx_instantiate<unsigned short, 4, 1>(rb_mCv, "Matx41w");
  Rice::Data_Type<cv::Vec<unsigned short, 4>> rb_cVec4w = Vec_instantiate<unsigned short, 4>(rb_mCv, "Vec4w");
