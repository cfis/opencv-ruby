...
void Init_Core_Ocl()
{
  ...
  rb_cCvOclDevice
    ...
    .define_constant("TYPE_DEFAULT", (int)cv::ocl::Device::TYPE_DEFAULT)
    .define_constant("TYPE_CPU", (int)cv::ocl::Device::TYPE_CPU)
    .define_constant("TYPE_GPU", (int)cv::ocl::Device::TYPE_GPU)
    .define_constant("TYPE_ACCELERATOR", (int)cv::ocl::Device::TYPE_ACCELERATOR)
    .define_constant("TYPE_DGPU", (int)cv::ocl::Device::TYPE_DGPU)
    .define_constant("TYPE_IGPU", (int)cv::ocl::Device::TYPE_IGPU)
    .define_constant("TYPE_ALL", (int)cv::ocl::Device::TYPE_ALL)
    .define_constant("FP_DENORM", (int)cv::ocl::Device::FP_DENORM)
    .define_constant("FP_INF_NAN", (int)cv::ocl::Device::FP_INF_NAN)
    .define_constant("FP_ROUND_TO_NEAREST", (int)cv::ocl::Device::FP_ROUND_TO_NEAREST)
    .define_constant("FP_ROUND_TO_ZERO", (int)cv::ocl::Device::FP_ROUND_TO_ZERO)
    .define_constant("FP_ROUND_TO_INF", (int)cv::ocl::Device::FP_ROUND_TO_INF)
    .define_constant("FP_FMA", (int)cv::ocl::Device::FP_FMA)
    .define_constant("FP_SOFT_FLOAT", (int)cv::ocl::Device::FP_SOFT_FLOAT)
    .define_constant("FP_CORRECTLY_ROUNDED_DIVIDE_SQRT", (int)cv::ocl::Device::FP_CORRECTLY_ROUNDED_DIVIDE_SQRT)
    .define_constant("EXEC_KERNEL", (int)cv::ocl::Device::EXEC_KERNEL)
    .define_constant("EXEC_NATIVE_KERNEL", (int)cv::ocl::Device::EXEC_NATIVE_KERNEL)
    .define_constant("NO_CACHE", (int)cv::ocl::Device::NO_CACHE)
    .define_constant("READ_ONLY_CACHE", (int)cv::ocl::Device::READ_ONLY_CACHE)
    .define_constant("READ_WRITE_CACHE", (int)cv::ocl::Device::READ_WRITE_CACHE)
    .define_constant("NO_LOCAL_MEM", (int)cv::ocl::Device::NO_LOCAL_MEM)
    .define_constant("LOCAL_IS_LOCAL", (int)cv::ocl::Device::LOCAL_IS_LOCAL)
    .define_constant("LOCAL_IS_GLOBAL", (int)cv::ocl::Device::LOCAL_IS_GLOBAL)
    .define_constant("UNKNOWN_VENDOR", (int)cv::ocl::Device::UNKNOWN_VENDOR)
    .define_constant("VENDOR_AMD", (int)cv::ocl::Device::VENDOR_AMD)
    .define_constant("VENDOR_INTEL", (int)cv::ocl::Device::VENDOR_INTEL)
    .define_constant("VENDOR_NVIDIA", (int)cv::ocl::Device::VENDOR_NVIDIA)
  ...
  Rice::Data_Type<cv::ocl::KernelArg> rb_cCvOclKernelArg = define_class_under<cv::ocl::KernelArg>(rb_mCvOcl, "KernelArg")
    ...
    .define_constant("LOCAL", (int)cv::ocl::KernelArg::LOCAL)
    .define_constant("READ_ONLY", (int)cv::ocl::KernelArg::READ_ONLY)
    .define_constant("WRITE_ONLY", (int)cv::ocl::KernelArg::WRITE_ONLY)
