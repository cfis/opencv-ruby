...
void Init_Core_Opengl()
{
  ...
  rb_mCvOgl.define_module_function<void(*)(const cv::ogl::Texture2D &, cv::Rect_<double>, cv::Rect_<double>)>("render", static_cast<void(*)(const cv::ogl::Texture2D &, cv::Rect_<double>, cv::Rect_<double>)>(&cv::ogl::render),
  ...
  rb_mCvOgl.define_module_function<void(*)(const cv::ogl::Arrays &, int, cv::Scalar)>("render", static_cast<void(*)(const cv::ogl::Arrays &, int, cv::Scalar)>(&cv::ogl::render),
    Arg("arr"), Arg("mode") = static_cast<int>(cv::ogl::POINTS), Arg("color") = static_cast<cv::Scalar>(cv::Scalar::all(255)));

  rb_mCvOgl.define_module_function<void(*)(const cv::ogl::Arrays &, cv::InputArray, int, cv::Scalar)>("render", static_cast<void(*)(const cv::ogl::Arrays &, cv::InputArray, int, cv::Scalar)>(&cv::ogl::render),
