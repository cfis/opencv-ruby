...
void Init_Core_Parallel_Backend_ParallelForTbb()
{
  ...
  Rice::Data_Type<cv::parallel::tbb::ParallelForBackend> rb_cCvParallelTbbParallelForBackend = define_class_under<cv::parallel::tbb::ParallelForBackend, cv::parallel::ParallelForAPI>(rb_mCvParallelTbb, "ParallelForBackend").
  ...
  Rice::Data_Type<cv::parallel::tbb::ParallelForBackend::CallbackProxy> rb_cCvParallelTbbParallelForBackendCallbackProxy = define_class_under<cv::parallel::tbb::ParallelForBackend::CallbackProxy>(rb_cCvParallelTbbParallelForBackend, "CallbackProxy").
    define_constructor(Constructor<cv::parallel::tbb::ParallelForBackend::CallbackProxy, int, cv::parallel::ParallelForAPI::FN_parallel_for_body_cb_t&, void*>(),
      Arg("tasks_"), Arg("callback_"), ArgBuffer("callback_data_")).
