...
void Init_Core_Parallel_ParallelBackend()
{
  ...
  rb_mCvParallel.define_module_function<void(*)(const std::shared_ptr<cv::parallel::ParallelForAPI> &, bool)>("set_parallel_for_backend", static_cast<void(*)(const std::shared_ptr<cv::parallel::ParallelForAPI> &, bool)>(&cv::parallel::setParallelForBackend),
    Arg("api"), Arg("propagate_num_threads") = static_cast<bool>(true));

  rb_mCvParallel.define_module_function<bool(*)(const std::string &, bool)>("set_parallel_for_backend", static_cast<bool(*)(const std::string &, bool)>(&cv::parallel::setParallelForBackend),
