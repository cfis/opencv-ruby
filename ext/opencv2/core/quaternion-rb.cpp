...
inline void Quat_builder(Data_Type_T& klass)
{
  klass.define_constant("CV_QUAT_EPS", cv::Quat<_Tp>::CV_QUAT_EPS).
    ...
    define_method("at", &cv::Quat<_Tp>::at,
      Arg("index")).
    define_method("conjugate", &cv::Quat<_Tp>::conjugate).
    define_method("exp", &cv::Quat<_Tp>::exp).
    define_method("log", &cv::Quat<_Tp>::log,
    ...
    define_method("sqrt", &cv::Quat<_Tp>::sqrt,
      Arg("assume_unit") = static_cast<cv::QuatAssumeType>(cv::QUAT_ASSUME_NOT_UNIT)).
    ...
    define_method("cross_product", &cv::Quat<_Tp>::crossProduct,
      Arg("q")).
    define_method("norm", &cv::Quat<_Tp>::norm).
    define_method("normalize", &cv::Quat<_Tp>::normalize).
    define_method("inv", &cv::Quat<_Tp>::inv,
      Arg("assume_unit") = static_cast<cv::QuatAssumeType>(cv::QUAT_ASSUME_NOT_UNIT)).
    define_method("sinh", &cv::Quat<_Tp>::sinh).
    define_method("cosh", &cv::Quat<_Tp>::cosh).
    define_method("tanh", &cv::Quat<_Tp>::tanh).
    ...
    define_method("assert_normal", &cv::Quat<_Tp>::assertNormal,
      Arg("eps") = static_cast<_Tp>(cv::Quat<_Tp>::CV_QUAT_EPS)).
    define_method("to_rot_mat3x3", &cv::Quat<_Tp>::toRotMat3x3,
      Arg("assume_unit") = static_cast<cv::QuatAssumeType>(cv::QUAT_ASSUME_NOT_UNIT)).
    define_method("to_rot_mat4x4", &cv::Quat<_Tp>::toRotMat4x4,
      Arg("assume_unit") = static_cast<cv::QuatAssumeType>(cv::QUAT_ASSUME_NOT_UNIT)).
    define_method("to_vec", &cv::Quat<_Tp>::toVec).
    define_method("to_rot_vec", &cv::Quat<_Tp>::toRotVec,
      Arg("assume_unit") = static_cast<cv::QuatAssumeType>(cv::QUAT_ASSUME_NOT_UNIT)).
    define_method("get_angle", &cv::Quat<_Tp>::getAngle,
      Arg("assume_unit") = static_cast<cv::QuatAssumeType>(cv::QUAT_ASSUME_NOT_UNIT)).
    define_method("get_axis", &cv::Quat<_Tp>::getAxis,
      Arg("assume_unit") = static_cast<cv::QuatAssumeType>(cv::QUAT_ASSUME_NOT_UNIT)).
    define_method("dot", &cv::Quat<_Tp>::dot,
      Arg("q")).
    template define_method<cv::Quat<_Tp>(cv::Quat<_Tp>::*)() const>("-", &cv::Quat<_Tp>::operator-).
    define_method("==", &cv::Quat<_Tp>::operator==,
      Arg("arg_0")).
    define_method("+", &cv::Quat<_Tp>::operator+,
      Arg("arg_0")).
    define_method("assign_plus", &cv::Quat<_Tp>::operator+=,
      Arg("arg_0")).
    template define_method<cv::Quat<_Tp>(cv::Quat<_Tp>::*)(const cv::Quat<_Tp>&) const>("-", &cv::Quat<_Tp>::operator-,
      Arg("arg_0")).
    define_method("assign_minus", &cv::Quat<_Tp>::operator-=,
      Arg("arg_0")).
    ...
    template define_method<const _Tp&(cv::Quat<_Tp>::*)(std::size_t) const>("[]", &cv::Quat<_Tp>::operator[],
      Arg("n")).
    define_method("to_euler_angles", &cv::Quat<_Tp>::toEulerAngles,
    ...
    define_singleton_function("create_from_angle_axis", &cv::Quat<_Tp>::createFromAngleAxis,
      Arg("angle"), Arg("axis")).
    define_singleton_function("create_from_rot_mat", &cv::Quat<_Tp>::createFromRotMat,
      Arg("r")).
    define_singleton_function("create_from_rvec", &cv::Quat<_Tp>::createFromRvec,
      Arg("rvec")).
    define_singleton_function("create_from_euler_angles", &cv::Quat<_Tp>::createFromEulerAngles,
      Arg("angles"), Arg("euler_angles_type")).
    define_singleton_function("create_from_y_rot", &cv::Quat<_Tp>::createFromYRot,
      Arg("theta")).
    define_singleton_function("create_from_x_rot", &cv::Quat<_Tp>::createFromXRot,
      Arg("theta")).
    define_singleton_function("create_from_z_rot", &cv::Quat<_Tp>::createFromZRot,
      Arg("theta")).
    define_singleton_function("lerp", &cv::Quat<_Tp>::lerp,
      Arg("q0"), Arg("q1"), Arg("t")).
    define_singleton_function("nlerp", &cv::Quat<_Tp>::nlerp,
      Arg("q0"), Arg("q1"), Arg("t"), Arg("assume_unit") = static_cast<cv::QuatAssumeType>(cv::QUAT_ASSUME_NOT_UNIT)).
    define_singleton_function("slerp", &cv::Quat<_Tp>::slerp,
    ...
    define_singleton_function("squad", &cv::Quat<_Tp>::squad,
    ...
    define_singleton_function("inter_point", &cv::Quat<_Tp>::interPoint,
