...
inline void Scalar__builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cv::Scalar_<_Tp>>()).
    ...
    define_method("real?", &cv::Scalar_<_Tp>::isReal).
...
void Init_Core_Types()
{
  ...
  Rice::Data_Type<cv::Point_<short>> rb_cPoint2s = define_class_under<cv::Point_<short>>(rb_mCv, "Point2s").
    define(&Point__builder<Data_Type<cv::Point_<short>>, short>);

  Rice::Data_Type<cv::Point_<unsigned short>> rb_cPoint2w = define_class_under<cv::Point_<unsigned short>>(rb_mCv, "Point2w").
  ...
  // Manual
  Rice::Data_Type<cv::Point3_<unsigned char>> rb_cPoint3b = define_class_under<cv::Point3_<unsigned char>>(rb_mCv, "Point3b").
    define(&Point3__builder<Data_Type<cv::Point3_<unsigned char>>, unsigned char>);

  Rice::Data_Type<cv::Point3_<short>> rb_cPoint3s = define_class_under<cv::Point3_<short>>(rb_mCv, "Point3s").
  ...
  Rice::Data_Type<cv::Size_<short>> rb_cSize2s = define_class_under<cv::Size_<short>>(rb_mCv, "Size2s").
  ...
  Rice::Data_Type<cv::Rect_<short>> rb_cRect2s = define_class_under<cv::Rect_<short>>(rb_mCv, "Rect2s").
    define(&Rect__builder<Data_Type<cv::Rect_<short>>, short>);

  Rice::Data_Type<cv::Rect_<unsigned short>> rb_cRect2w = define_class_under<cv::Rect_<unsigned short>>(rb_mCv, "Rect2w").
    define(&Rect__builder<Data_Type<cv::Rect_<unsigned short>>, unsigned short>);

  Rice::Data_Type<cv::Rect_<int64>> rb_cRect2l = define_class_under<cv::Rect_<int64>>(rb_mCv, "Rect2l").
    define(&Rect__builder<Data_Type<cv::Rect_<int64>>, int64>);
