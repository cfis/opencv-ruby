...
void Init_Core_Types()
{
  ...
  // Rice::Data_Type<cv::Matx<double, 4, 1>> rb_cMatx41d = Matx_instantiate<double, 4, 1>(rb_mCv, "Matx41d"); // Already defined in matx-rb.cpp
  // Rice::Data_Type<cv::Vec<double, 4>> rb_cVec4d = Vec_instantiate<double, 4>(rb_mCv, "Vec4d"); // Already defined in matx-rb.cpp
