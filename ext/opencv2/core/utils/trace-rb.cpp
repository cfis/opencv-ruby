...
void Init_Core_Utils_Trace()
{
  ...
  rb_mCvUtilsTraceDetails.define_module_function<void(*)(const cv::utils::trace::details::TraceArg &, const char *)>("trace_arg", static_cast<void(*)(const cv::utils::trace::details::TraceArg &, const char *)>(&cv::utils::trace::details::traceArg),
    Arg("arg"), Arg("value"));

  rb_mCvUtilsTraceDetails.define_module_function<void(*)(const cv::utils::trace::details::TraceArg &, int)>("trace_arg", static_cast<void(*)(const cv::utils::trace::details::TraceArg &, int)>(&cv::utils::trace::details::traceArg),
    Arg("arg"), Arg("value"));

  rb_mCvUtilsTraceDetails.define_module_function<void(*)(const cv::utils::trace::details::TraceArg &, int64)>("trace_arg", static_cast<void(*)(const cv::utils::trace::details::TraceArg &, int64)>(&cv::utils::trace::details::traceArg),
    Arg("arg"), Arg("value"));

  rb_mCvUtilsTraceDetails.define_module_function<void(*)(const cv::utils::trace::details::TraceArg &, double)>("trace_arg", static_cast<void(*)(const cv::utils::trace::details::TraceArg &, double)>(&cv::utils::trace::details::traceArg),
    Arg("arg"), Arg("value"));
}
