...
void Init_Cudafeatures2d()
{
  ...
  Rice::Data_Type<cv::cuda::DescriptorMatcher> rb_cCvCudaDescriptorMatcher = define_class_under<cv::cuda::DescriptorMatcher, cv::Algorithm>(rb_mCvCuda, "DescriptorMatcher").
    define_method("mask_supported?", &cv::cuda::DescriptorMatcher::isMaskSupported).
    define_method("add", &cv::cuda::DescriptorMatcher::add,
      Arg("descriptors")).
    define_method("get_train_descriptors", &cv::cuda::DescriptorMatcher::getTrainDescriptors).
    define_method("clear", &cv::cuda::DescriptorMatcher::clear).
    define_method("empty?", &cv::cuda::DescriptorMatcher::empty).
    define_method("train", &cv::cuda::DescriptorMatcher::train).
    ...
    define_method("match_convert", &cv::cuda::DescriptorMatcher::matchConvert,
    ...
    define_method("knn_match_convert", &cv::cuda::DescriptorMatcher::knnMatchConvert,
    ...
    define_method("radius_match_convert", &cv::cuda::DescriptorMatcher::radiusMatchConvert,
      Arg("gpu_matches"), Arg("matches"), Arg("compact_result") = static_cast<bool>(false)).
    define_singleton_function("create_bf_matcher", &cv::cuda::DescriptorMatcher::createBFMatcher,
  ...
  Rice::Data_Type<cv::cuda::Feature2DAsync> rb_cCvCudaFeature2DAsync = define_class_under<cv::cuda::Feature2DAsync, cv::Feature2D>(rb_mCvCuda, "Feature2DAsync").
    define_method("detect_async", &cv::cuda::Feature2DAsync::detectAsync,
    ...
    define_method("compute_async", &cv::cuda::Feature2DAsync::computeAsync,
      Arg("image"), Arg("keypoints"), Arg("descriptors"), Arg("stream") = static_cast<cv::cuda::Stream&>(cv::cuda::Stream::Null())).
    define_method("detect_and_compute_async", &cv::cuda::Feature2DAsync::detectAndComputeAsync,
    ...
    define_method("convert", &cv::cuda::Feature2DAsync::convert,
  ...
  Rice::Data_Type<cv::cuda::FastFeatureDetector> rb_cCvCudaFastFeatureDetector = define_class_under<cv::cuda::FastFeatureDetector, cv::cuda::Feature2DAsync>(rb_mCvCuda, "FastFeatureDetector").
    ...
    define_method("set_threshold", &cv::cuda::FastFeatureDetector::setThreshold,
      Arg("threshold")).
    define_method("set_max_num_points", &cv::cuda::FastFeatureDetector::setMaxNumPoints,
      Arg("max_npoints")).
    define_method("get_max_num_points", &cv::cuda::FastFeatureDetector::getMaxNumPoints).
    define_singleton_function("create", &cv::cuda::FastFeatureDetector::create,
  ...
  Rice::Data_Type<cv::cuda::ORB> rb_cCvCudaORB = define_class_under<cv::cuda::ORB, cv::cuda::Feature2DAsync>(rb_mCvCuda, "ORB").
    ...
    define_method("set_max_features", &cv::cuda::ORB::setMaxFeatures,
      Arg("max_features")).
    define_method("get_max_features", &cv::cuda::ORB::getMaxFeatures).
    define_method("set_scale_factor", &cv::cuda::ORB::setScaleFactor,
      Arg("scale_factor")).
    define_method("get_scale_factor", &cv::cuda::ORB::getScaleFactor).
    define_method("set_n_levels", &cv::cuda::ORB::setNLevels,
      Arg("nlevels")).
    define_method("get_n_levels", &cv::cuda::ORB::getNLevels).
    define_method("set_edge_threshold", &cv::cuda::ORB::setEdgeThreshold,
      Arg("edge_threshold")).
    define_method("get_edge_threshold", &cv::cuda::ORB::getEdgeThreshold).
    define_method("set_first_level", &cv::cuda::ORB::setFirstLevel,
      Arg("first_level")).
    define_method("get_first_level", &cv::cuda::ORB::getFirstLevel).
    define_method("set_wta_k", &cv::cuda::ORB::setWTA_K,
      Arg("wta_k")).
    define_method("get_wta_k", &cv::cuda::ORB::getWTA_K).
    define_method("set_score_type", &cv::cuda::ORB::setScoreType,
      Arg("score_type")).
    define_method("get_score_type", &cv::cuda::ORB::getScoreType).
    define_method("set_patch_size", &cv::cuda::ORB::setPatchSize,
      Arg("patch_size")).
    define_method("get_patch_size", &cv::cuda::ORB::getPatchSize).
    define_method("set_fast_threshold", &cv::cuda::ORB::setFastThreshold,
      Arg("fast_threshold")).
    define_method("get_fast_threshold", &cv::cuda::ORB::getFastThreshold).
    define_method("set_blur_for_descriptor", &cv::cuda::ORB::setBlurForDescriptor,
      Arg("blur_for_descriptor")).
    define_method("get_blur_for_descriptor?", &cv::cuda::ORB::getBlurForDescriptor).
    define_singleton_function("create", &cv::cuda::ORB::create,
