...
void Init_Cudaimgproc()
{
  ...
  rb_mCvCuda.define_module_function<void(*)(cv::InputArray, cv::OutputArray, cv::cuda::Stream &)>("calc_hist", static_cast<void(*)(cv::InputArray, cv::OutputArray, cv::cuda::Stream &)>(&cv::cuda::calcHist),
    Arg("src"), Arg("hist"), Arg("stream") = static_cast<cv::cuda::Stream &>(cv::cuda::Stream::Null()));

  rb_mCvCuda.define_module_function<void(*)(cv::InputArray, cv::InputArray, cv::OutputArray, cv::cuda::Stream &)>("calc_hist", static_cast<void(*)(cv::InputArray, cv::InputArray, cv::OutputArray, cv::cuda::Stream &)>(&cv::cuda::calcHist),
  ...
  rb_mCvCuda.define_module_function<void(*)(cv::InputArray, cv::OutputArray, int, int, int, cv::cuda::Stream &)>("hist_even", static_cast<void(*)(cv::InputArray, cv::OutputArray, int, int, int, cv::cuda::Stream &)>(&cv::cuda::histEven),
    Arg("src"), Arg("hist"), Arg("hist_size"), Arg("lower_level"), Arg("upper_level"), Arg("stream") = static_cast<cv::cuda::Stream &>(cv::cuda::Stream::Null()));

  rb_mCvCuda.define_module_function<void(*)(cv::InputArray, cv::cuda::GpuMat[4], int[4], int[4], int[4], cv::cuda::Stream &)>("hist_even", static_cast<void(*)(cv::InputArray, cv::cuda::GpuMat[4], int[4], int[4], int[4], cv::cuda::Stream &)>(&cv::cuda::histEven),
    Arg("src"), Arg("hist"), Arg("hist_size"), Arg("lower_level"), Arg("upper_level"), Arg("stream") = static_cast<cv::cuda::Stream &>(cv::cuda::Stream::Null()));

  rb_mCvCuda.define_module_function<void(*)(cv::InputArray, cv::OutputArray, cv::InputArray, cv::cuda::Stream &)>("hist_range", static_cast<void(*)(cv::InputArray, cv::OutputArray, cv::InputArray, cv::cuda::Stream &)>(&cv::cuda::histRange),
    Arg("src"), Arg("hist"), Arg("levels"), Arg("stream") = static_cast<cv::cuda::Stream &>(cv::cuda::Stream::Null()));

  rb_mCvCuda.define_module_function<void(*)(cv::InputArray, cv::cuda::GpuMat[4], const cv::cuda::GpuMat[4], cv::cuda::Stream &)>("hist_range", static_cast<void(*)(cv::InputArray, cv::cuda::GpuMat[4], const cv::cuda::GpuMat[4], cv::cuda::Stream &)>(&cv::cuda::histRange),
    Arg("src"), Arg("hist"), Arg("levels"), Arg("stream") = static_cast<cv::cuda::Stream &>(cv::cuda::Stream::Null()));
  ...
  rb_mCvCuda.define_module_function<void(*)(cv::InputArray, cv::OutputArray, int, int, cv::cuda::ConnectedComponentsAlgorithmsTypes)>("connected_components", static_cast<void(*)(cv::InputArray, cv::OutputArray, int, int, cv::cuda::ConnectedComponentsAlgorithmsTypes)>(&cv::cuda::connectedComponents),
    Arg("image"), Arg("labels"), Arg("connectivity"), Arg("ltype"), Arg("ccltype"));

  rb_mCvCuda.define_module_function<void(*)(cv::InputArray, cv::OutputArray, int, int)>("connected_components", static_cast<void(*)(cv::InputArray, cv::OutputArray, int, int)>(&cv::cuda::connectedComponents),
