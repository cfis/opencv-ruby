...
void Init_Cudalegacy()
{
  ...
  Rice::Data_Type<cv::cuda::ImagePyramid> rb_cCvCudaImagePyramid = define_class_under<cv::cuda::ImagePyramid, cv::Algorithm>(rb_mCvCuda, "ImagePyramid").
    define_method("get_layer", &cv::cuda::ImagePyramid::getLayer,
      Arg("out_img"), Arg("out_roi"), Arg("stream") = static_cast<cv::cuda::Stream&>(cv::cuda::Stream::Null()));

  rb_mCvCuda.define_module_function("create_image_pyramid", &cv::cuda::createImagePyramid,
  ...
  Rice::Data_Type<cv::cuda::BackgroundSubtractorGMG> rb_cCvCudaBackgroundSubtractorGMG = define_class_under<cv::cuda::BackgroundSubtractorGMG, cv::BackgroundSubtractor>(rb_mCvCuda, "BackgroundSubtractorGMG").
    define_method("apply", &cv::cuda::BackgroundSubtractorGMG::apply,
      Arg("image"), Arg("fgmask"), Arg("learning_rate"), Arg("stream")).
    define_method("get_max_features", &cv::cuda::BackgroundSubtractorGMG::getMaxFeatures).
    define_method("set_max_features", &cv::cuda::BackgroundSubtractorGMG::setMaxFeatures,
      Arg("max_features")).
    define_method("get_default_learning_rate", &cv::cuda::BackgroundSubtractorGMG::getDefaultLearningRate).
    define_method("set_default_learning_rate", &cv::cuda::BackgroundSubtractorGMG::setDefaultLearningRate,
      Arg("lr")).
    define_method("get_num_frames", &cv::cuda::BackgroundSubtractorGMG::getNumFrames).
    define_method("set_num_frames", &cv::cuda::BackgroundSubtractorGMG::setNumFrames,
      Arg("nframes")).
    define_method("get_quantization_levels", &cv::cuda::BackgroundSubtractorGMG::getQuantizationLevels).
    define_method("set_quantization_levels", &cv::cuda::BackgroundSubtractorGMG::setQuantizationLevels,
      Arg("nlevels")).
    define_method("get_background_prior", &cv::cuda::BackgroundSubtractorGMG::getBackgroundPrior).
    define_method("set_background_prior", &cv::cuda::BackgroundSubtractorGMG::setBackgroundPrior,
      Arg("bgprior")).
    define_method("get_smoothing_radius", &cv::cuda::BackgroundSubtractorGMG::getSmoothingRadius).
    define_method("set_smoothing_radius", &cv::cuda::BackgroundSubtractorGMG::setSmoothingRadius,
      Arg("radius")).
    define_method("get_decision_threshold", &cv::cuda::BackgroundSubtractorGMG::getDecisionThreshold).
    define_method("set_decision_threshold", &cv::cuda::BackgroundSubtractorGMG::setDecisionThreshold,
      Arg("thresh")).
    define_method("get_update_background_model?", &cv::cuda::BackgroundSubtractorGMG::getUpdateBackgroundModel).
    define_method("set_update_background_model", &cv::cuda::BackgroundSubtractorGMG::setUpdateBackgroundModel,
      Arg("update")).
    define_method("get_min_val", &cv::cuda::BackgroundSubtractorGMG::getMinVal).
    define_method("set_min_val", &cv::cuda::BackgroundSubtractorGMG::setMinVal,
      Arg("val")).
    define_method("get_max_val", &cv::cuda::BackgroundSubtractorGMG::getMaxVal).
    define_method("set_max_val", &cv::cuda::BackgroundSubtractorGMG::setMaxVal,
      Arg("val"));

  rb_mCvCuda.define_module_function("create_background_subtractor_gmg", &cv::cuda::createBackgroundSubtractorGMG,
  ...
  Rice::Data_Type<cv::cuda::BackgroundSubtractorFGD> rb_cCvCudaBackgroundSubtractorFGD = define_class_under<cv::cuda::BackgroundSubtractorFGD, cv::BackgroundSubtractor>(rb_mCvCuda, "BackgroundSubtractorFGD").
    define_method("get_foreground_regions", &cv::cuda::BackgroundSubtractorFGD::getForegroundRegions,
  ...
  rb_mCvCuda.define_module_function("create_background_subtractor_fgd", &cv::cuda::createBackgroundSubtractorFGD,
    Arg("params") = static_cast<const cv::cuda::FGDParams&>(cv::cuda::FGDParams()));

  rb_mCvCuda.define_module_function("calc_optical_flow_bm", &cv::cuda::calcOpticalFlowBM,
  ...
  Rice::Data_Type<cv::cuda::FastOpticalFlowBM> rb_cCvCudaFastOpticalFlowBM = define_class_under<cv::cuda::FastOpticalFlowBM>(rb_mCvCuda, "FastOpticalFlowBM").
    ...
    define_method("call", &cv::cuda::FastOpticalFlowBM::operator(),
  ...
  rb_mCvCuda.define_module_function("interpolate_frames", &cv::cuda::interpolateFrames,
  ...
  rb_mCvCuda.define_module_function("create_optical_flow_needle_map", &cv::cuda::createOpticalFlowNeedleMap,
