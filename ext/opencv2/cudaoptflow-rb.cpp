...
void Init_Cudaoptflow()
{
  ...
  Rice::Data_Type<cv::cuda::NvidiaOpticalFlow_1_0> rb_cCvCudaNvidiaOpticalFlow10 = define_class_under<cv::cuda::NvidiaOpticalFlow_1_0, cv::cuda::NvidiaHWOpticalFlow>(rb_mCvCuda, "NvidiaOpticalFlow10").
    ...
    define_singleton_function<cv::Ptr<cv::cuda::NvidiaOpticalFlow_1_0>(*)(cv::Size, cv::cuda::NvidiaOpticalFlow_1_0::NVIDIA_OF_PERF_LEVEL, bool, bool, bool, int, cv::cuda::Stream&, cv::cuda::Stream&)>("create", &cv::cuda::NvidiaOpticalFlow_1_0::create,
      Arg("image_size"), Arg("perf_preset") = static_cast<cv::cuda::NvidiaOpticalFlow_1_0::NVIDIA_OF_PERF_LEVEL>(cv::cuda::NvidiaOpticalFlow_1_0::NVIDIA_OF_PERF_LEVEL perfPreset
    cv::cuda::NvidiaOpticalFlow_1_0::NVIDIA_OF_PERF_LEVEL::NV_OF_PERF_LEVEL_SLOW), Arg("enable_temporal_hints") = static_cast<bool>(false), Arg("enable_external_hints") = static_cast<bool>(false), Arg("enable_cost_buffer") = static_cast<bool>(false), Arg("gpu_id") = static_cast<int>(0), Arg("input_stream") = static_cast<cv::cuda::Stream&>(cv::cuda::Stream::Null()), Arg("output_stream") = static_cast<cv::cuda::Stream&>(cv::cuda::Stream::Null()));
  ...
  Rice::Data_Type<cv::cuda::NvidiaOpticalFlow_2_0> rb_cCvCudaNvidiaOpticalFlow20 = define_class_under<cv::cuda::NvidiaOpticalFlow_2_0, cv::cuda::NvidiaHWOpticalFlow>(rb_mCvCuda, "NvidiaOpticalFlow20").
    ...
    define_singleton_function<cv::Ptr<cv::cuda::NvidiaOpticalFlow_2_0>(*)(cv::Size, cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL, cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE, cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_HINT_VECTOR_GRID_SIZE, bool, bool, bool, int, cv::cuda::Stream&, cv::cuda::Stream&)>("create", &cv::cuda::NvidiaOpticalFlow_2_0::create,
      Arg("image_size"), Arg("perf_preset") = static_cast<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL>(cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL perfPreset
    cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL::NV_OF_PERF_LEVEL_SLOW), Arg("output_grid_size") = static_cast<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE>(cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE outputGridSize
    cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE::NV_OF_OUTPUT_VECTOR_GRID_SIZE_1), Arg("hint_grid_size") = static_cast<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_HINT_VECTOR_GRID_SIZE>(cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_HINT_VECTOR_GRID_SIZE hintGridSize
    ...
    define_singleton_function<cv::Ptr<cv::cuda::NvidiaOpticalFlow_2_0>(*)(cv::Size, std::vector<cv::Rect_<int>>, cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL, cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE, cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_HINT_VECTOR_GRID_SIZE, bool, bool, bool, int, cv::cuda::Stream&, cv::cuda::Stream&)>("create", &cv::cuda::NvidiaOpticalFlow_2_0::create,
      Arg("image_size"), Arg("roi_data"), Arg("perf_preset") = static_cast<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL>(cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL perfPreset
    cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL::NV_OF_PERF_LEVEL_SLOW), Arg("output_grid_size") = static_cast<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE>(cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE outputGridSize
    cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE::NV_OF_OUTPUT_VECTOR_GRID_SIZE_1), Arg("hint_grid_size") = static_cast<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_HINT_VECTOR_GRID_SIZE>(cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_HINT_VECTOR_GRID_SIZE hintGridSize
    cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_HINT_VECTOR_GRID_SIZE::NV_OF_HINT_VECTOR_GRID_SIZE_1), Arg("enable_temporal_hints") = static_cast<bool>(false), Arg("enable_external_hints") = static_cast<bool>(false), Arg("enable_cost_buffer") = static_cast<bool>(false), Arg("gpu_id") = static_cast<int>(0), Arg("input_stream") = static_cast<cv::cuda::Stream&>(cv::cuda::Stream::Null()), Arg("output_stream") = static_cast<cv::cuda::Stream&>(cv::cuda::Stream::Null()));
