...
void Init_Cudaoptflow()
{
  ...
  Enum<cv::cuda::NvidiaOpticalFlow_1_0::NVIDIA_OF_PERF_LEVEL> rb_cCvCudaNvidiaOpticalFlow10NVIDIAOFPERFLEVEL = define_enum_under<cv::cuda::NvidiaOpticalFlow_1_0::NVIDIA_OF_PERF_LEVEL>("NvidiaOfPerfLevel", rb_cCvCudaNvidiaOpticalFlow10)
  ...
  Enum<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL> rb_cCvCudaNvidiaOpticalFlow20NVIDIAOFPERFLEVEL = define_enum_under<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_PERF_LEVEL>("NvidiaOfPerfLevel", rb_cCvCudaNvidiaOpticalFlow20)
  ...
  Enum<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE> rb_cCvCudaNvidiaOpticalFlow20NVIDIAOFOUTPUTVECTORGRIDSIZE = define_enum_under<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_OUTPUT_VECTOR_GRID_SIZE>("NvidiaOfOutputVectorGridSize", rb_cCvCudaNvidiaOpticalFlow20)
  ...
  Enum<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_HINT_VECTOR_GRID_SIZE> rb_cCvCudaNvidiaOpticalFlow20NVIDIAOFHINTVECTORGRIDSIZE = define_enum_under<cv::cuda::NvidiaOpticalFlow_2_0::NVIDIA_OF_HINT_VECTOR_GRID_SIZE>("NvidiaOfHintVectorGridSize", rb_cCvCudaNvidiaOpticalFlow20)
