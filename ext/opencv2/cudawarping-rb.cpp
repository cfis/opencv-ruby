...
void Init_Cudawarping()
{
  ...
  rb_mCvCuda.define_module_function("remap", &cv::cuda::remap,
  ...
  rb_mCvCuda.define_module_function("resize", &cv::cuda::resize,
  ...
  rb_mCvCuda.define_module_function("rotate", &cv::cuda::rotate,
  ...
  rb_mCvCuda.define_module_function("pyr_down", &cv::cuda::pyrDown,
    Arg("src"), Arg("dst"), Arg("stream") = static_cast<cv::cuda::Stream&>(cv::cuda::Stream::Null()));

  rb_mCvCuda.define_module_function("pyr_up", &cv::cuda::pyrUp,
    Arg("src"), Arg("dst"), Arg("stream") = static_cast<cv::cuda::Stream&>(cv::cuda::Stream::Null()));
}