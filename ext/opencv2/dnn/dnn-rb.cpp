...
void Init_Dnn_Dnn()
{
  ...
  rb_cCvDnnDnn4V20241223Net.
    ...
    define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const std::vector<std::vector<int>>&, std::vector<int>&, std::vector<std::size_t>&, std::vector<std::size_t>&) const>("get_memory_consumption", &cv::dnn::dnn4_v20241223::Net::getMemoryConsumption,
