...
void Init_Dnn_Dnn()
{
  ...
  Rice::Data_Type<cv::dnn::dnn4_v20241223::Layer> rb_cCvDnnDnn4V20241223Layer = define_class_under<cv::dnn::dnn4_v20241223::Layer, cv::Algorithm>(rb_mCvDnnDnn4V20241223, "Layer")
    ...
    .define_method<bool(cv::dnn::dnn4_v20241223::Layer::*)(const std::vector<cv::dnn::dnn4_v20241223::MatShape>&, const int, std::vector<cv::dnn::dnn4_v20241223::MatShape>&, std::vector<cv::dnn::dnn4_v20241223::MatShape>&) const>("get_memory_shapes", &cv::dnn::dnn4_v20241223::Layer::getMemoryShapes,
      Arg("inputs"), Arg("required_outputs"), Arg("outputs"), Arg("internals"))
    .define_method<int64(cv::dnn::dnn4_v20241223::Layer::*)(const std::vector<cv::dnn::dnn4_v20241223::MatShape>&, const std::vector<cv::dnn::dnn4_v20241223::MatShape>&) const>("get_flops", &cv::dnn::dnn4_v20241223::Layer::getFLOPS,
      Arg("inputs"), Arg("outputs"))
    .define_method<bool(cv::dnn::dnn4_v20241223::Layer::*)(const std::vector<cv::dnn::dnn4_v20241223::MatShape>&)>("update_memory_shapes", &cv::dnn::dnn4_v20241223::Layer::updateMemoryShapes,
      Arg("inputs"))
  ...
  rb_cCvDnnDnn4V20241223Net
    ...
    .define_method<int(cv::dnn::dnn4_v20241223::Net::*)(const cv::String&) const>("get_layer_id", &cv::dnn::dnn4_v20241223::Net::getLayerId,
      Arg("layer"))
    .define_method<std::vector<cv::String>(cv::dnn::dnn4_v20241223::Net::*)() const>("get_layer_names", &cv::dnn::dnn4_v20241223::Net::getLayerNames)
    ...
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const std::vector<cv::String>&)>("set_inputs_names", &cv::dnn::dnn4_v20241223::Net::setInputsNames,
    ...
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(cv::OutputArrayOfArrays, const std::vector<cv::String>&)>("forward", &cv::dnn::dnn4_v20241223::Net::forward,
      Arg("output_blobs"), Arg("out_blob_names"))
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(std::vector<std::vector<cv::Mat>>&, const std::vector<cv::String>&)>("forward", &cv::dnn::dnn4_v20241223::Net::forward,
      Arg("output_blobs"), Arg("out_blob_names"))
    ...
    .define_method<std::vector<cv::String>(cv::dnn::dnn4_v20241223::Net::*)() const>("get_unconnected_out_layers_names", &cv::dnn::dnn4_v20241223::Net::getUnconnectedOutLayersNames)
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const std::vector<cv::dnn::dnn4_v20241223::MatShape>&, std::vector<int>&, std::vector<std::vector<cv::dnn::dnn4_v20241223::MatShape>>&, std::vector<std::vector<cv::dnn::dnn4_v20241223::MatShape>>&) const>("get_layers_shapes", &cv::dnn::dnn4_v20241223::Net::getLayersShapes,
      Arg("net_input_shapes"), Arg("layers_ids"), Arg("in_layers_shapes"), Arg("out_layers_shapes"))
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const cv::dnn::dnn4_v20241223::MatShape&, std::vector<int>&, std::vector<std::vector<cv::dnn::dnn4_v20241223::MatShape>>&, std::vector<std::vector<cv::dnn::dnn4_v20241223::MatShape>>&) const>("get_layers_shapes", &cv::dnn::dnn4_v20241223::Net::getLayersShapes,
      Arg("net_input_shape"), Arg("layers_ids"), Arg("in_layers_shapes"), Arg("out_layers_shapes"))
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const cv::dnn::dnn4_v20241223::MatShape&, const int, std::vector<cv::dnn::dnn4_v20241223::MatShape>&, std::vector<cv::dnn::dnn4_v20241223::MatShape>&) const>("get_layer_shapes", &cv::dnn::dnn4_v20241223::Net::getLayerShapes,
      Arg("net_input_shape"), Arg("layer_id"), Arg("in_layer_shapes"), Arg("out_layer_shapes"))
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const std::vector<cv::dnn::dnn4_v20241223::MatShape>&, const int, std::vector<cv::dnn::dnn4_v20241223::MatShape>&, std::vector<cv::dnn::dnn4_v20241223::MatShape>&) const>("get_layer_shapes", &cv::dnn::dnn4_v20241223::Net::getLayerShapes,
      Arg("net_input_shapes"), Arg("layer_id"), Arg("in_layer_shapes"), Arg("out_layer_shapes"))
    .define_method<int64(cv::dnn::dnn4_v20241223::Net::*)(const std::vector<cv::dnn::dnn4_v20241223::MatShape>&) const>("get_flops", &cv::dnn::dnn4_v20241223::Net::getFLOPS,
    ...
    .define_method<int64(cv::dnn::dnn4_v20241223::Net::*)(const cv::dnn::dnn4_v20241223::MatShape&) const>("get_flops", &cv::dnn::dnn4_v20241223::Net::getFLOPS,
      Arg("net_input_shape"))
    .define_method<int64(cv::dnn::dnn4_v20241223::Net::*)(const int, const std::vector<cv::dnn::dnn4_v20241223::MatShape>&) const>("get_flops", &cv::dnn::dnn4_v20241223::Net::getFLOPS,
    ...
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(std::vector<cv::String>&) const>("get_layer_types", &cv::dnn::dnn4_v20241223::Net::getLayerTypes,
      Arg("layers_types"))
    .define_method<int(cv::dnn::dnn4_v20241223::Net::*)(const cv::String&) const>("get_layers_count", &cv::dnn::dnn4_v20241223::Net::getLayersCount,
      Arg("layer_type"))
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const std::vector<cv::dnn::dnn4_v20241223::MatShape>&, size_t&, size_t&) const>("get_memory_consumption", &cv::dnn::dnn4_v20241223::Net::getMemoryConsumption,
    ...
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const int, const std::vector<cv::dnn::dnn4_v20241223::MatShape>&, size_t&, size_t&) const>("get_memory_consumption", &cv::dnn::dnn4_v20241223::Net::getMemoryConsumption,
    ...
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const std::vector<cv::dnn::dnn4_v20241223::MatShape>&, std::vector<int>&, std::vector<std::size_t>&, std::vector<std::size_t>&) const>("get_memory_consumption", &cv::dnn::dnn4_v20241223::Net::getMemoryConsumption,
      Arg("net_input_shapes"), Arg("layer_ids"), Arg("weights"), Arg("blobs"))
    .define_method<void(cv::dnn::dnn4_v20241223::Net::*)(const cv::dnn::dnn4_v20241223::MatShape&, std::vector<int>&, std::vector<std::size_t>&, std::vector<std::size_t>&) const>("get_memory_consumption", &cv::dnn::dnn4_v20241223::Net::getMemoryConsumption,
  ...
  rb_mCvDnnDnn4V20241223.define_module_function<void(*)(const cv::String&, const cv::String&, const std::vector<cv::String>&)>("shrink_caffe_model", &cv::dnn::dnn4_v20241223::shrinkCaffeModel,
  ...
  rb_mCvDnnDnn4V20241223.define_module_function<void(*)(const std::vector<cv::Rect>&, const std::vector<float>&, const float, const float, std::vector<int>&, const float, const int)>("nms_boxes", &cv::dnn::dnn4_v20241223::NMSBoxes,
  ...
  rb_mCvDnnDnn4V20241223.define_module_function<void(*)(const std::vector<cv::Rect2d>&, const std::vector<float>&, const float, const float, std::vector<int>&, const float, const int)>("nms_boxes", &cv::dnn::dnn4_v20241223::NMSBoxes,
    Arg("bboxes"), Arg("scores"), Arg("score_threshold"), Arg("nms_threshold"), Arg("indices"), Arg("eta") = static_cast<const float>(1.f), Arg("top_k") = static_cast<const int>(0));
  ...
  rb_mCvDnnDnn4V20241223.define_module_function<void(*)(const std::vector<cv::Rect>&, const std::vector<float>&, const std::vector<int>&, const float, const float, std::vector<int>&, const float, const int)>("nms_boxes_batched", &cv::dnn::dnn4_v20241223::NMSBoxesBatched,
  ...
  rb_mCvDnnDnn4V20241223.define_module_function<void(*)(const std::vector<cv::Rect2d>&, const std::vector<float>&, const std::vector<int>&, const float, const float, std::vector<int>&, const float, const int)>("nms_boxes_batched", &cv::dnn::dnn4_v20241223::NMSBoxesBatched,
    Arg("bboxes"), Arg("scores"), Arg("class_ids"), Arg("score_threshold"), Arg("nms_threshold"), Arg("indices"), Arg("eta") = static_cast<const float>(1.f), Arg("top_k") = static_cast<const int>(0));
  ...
  rb_cCvDnnDnn4V20241223Model
    ...
    .define_method<cv::dnn::dnn4_v20241223::Model&(cv::dnn::dnn4_v20241223::Model::*)(bool)>("set_input_swap_rb", &cv::dnn::dnn4_v20241223::Model::setInputSwapRB,
      Arg("swap_rb"))
    .define_method<cv::dnn::dnn4_v20241223::Model&(cv::dnn::dnn4_v20241223::Model::*)(const std::vector<cv::String>&)>("set_output_names", &cv::dnn::dnn4_v20241223::Model::setOutputNames,
      Arg("out_names"))
  ...
  Rice::Data_Type<cv::dnn::dnn4_v20241223::TextDetectionModel> rb_cCvDnnDnn4V20241223TextDetectionModel = define_class_under<cv::dnn::dnn4_v20241223::TextDetectionModel, cv::dnn::dnn4_v20241223::Model>(rb_mCvDnnDnn4V20241223, "TextDetectionModel")
    ...
    .define_method<void(cv::dnn::dnn4_v20241223::TextDetectionModel::*)(cv::InputArray, std::vector<std::vector<cv::Point>>&) const>("detect", &cv::dnn::dnn4_v20241223::TextDetectionModel::detect,
