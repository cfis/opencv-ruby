...
void Init_Face_PredictCollector()
{
  ...
  Rice::Data_Type<cv::face::PredictCollector> rb_cCvFacePredictCollector = define_class_under<cv::face::PredictCollector>(rb_mCvFace, "PredictCollector").
    define_method("init", &cv::face::PredictCollector::init,
      Arg("size")).
    define_method("collect", &cv::face::PredictCollector::collect,
      Arg("label"), Arg("dist"));
  ...
  Rice::Data_Type<cv::face::StandardCollector> rb_cCvFaceStandardCollector = define_class_under<cv::face::StandardCollector, cv::face::PredictCollector>(rb_mCvFace, "StandardCollector").
    ...
    define_method("init", &cv::face::StandardCollector::init,
      Arg("size")).
    define_method("collect", &cv::face::StandardCollector::collect,
      Arg("label"), Arg("dist")).
    define_method("get_min_label", &cv::face::StandardCollector::getMinLabel).
    define_method("get_min_dist", &cv::face::StandardCollector::getMinDist).
    define_method("get_results", &cv::face::StandardCollector::getResults,
      Arg("sorted") = static_cast<bool>(false)).
    define_method("get_results_map", &cv::face::StandardCollector::getResultsMap).
    define_singleton_function("create", &cv::face::StandardCollector::create,
