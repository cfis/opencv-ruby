template<typename T>
inline Rice::Data_Type<cv::Accumulator<T>> Accumulator_instantiate(Rice::Module parent, const char* name)
{
  return Rice::define_class_under<cv::Accumulator<T>>(parent, name);
}
