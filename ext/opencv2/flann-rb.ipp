template<typename T>
inline Rice::Data_Type<cv::flann::CvType<T>> CvType_instantiate(Rice::Module parent, const char* name)
{
  return Rice::define_class_under<cv::flann::CvType<T>>(parent, name);
}
...
template<typename T>
inline Rice::Data_Type<cv::flann::Index_<T>> Index__instantiate(Rice::Module parent, const char* name)
{
  return Rice::define_class_under<cv::flann::Index_<T>>(parent, name);
}
