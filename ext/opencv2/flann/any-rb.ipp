...
template<typename T>
inline Rice::Data_Type<cvflann::anyimpl::choose_policy<T>> choose_policy_instantiate(Rice::Module parent, const char* name)
{
  return Rice::define_class_under<cvflann::anyimpl::choose_policy<T>>(parent, name);
}
