...
inline Rice::Data_Type<cvflann::AutotunedIndex<Distance>> AutotunedIndex_instantiate(Rice::Module parent, const char* name)
{
  return Rice::define_class_under<cvflann::AutotunedIndex<Distance>, cvflann::NNIndex<Distance>>(parent, name)
    ...
    .template define_method<void(cvflann::AutotunedIndex<Distance>::*)(FILE *)>("load_index", &cvflann::AutotunedIndex<Distance>::loadIndex,
      Arg("stream"))
    .template define_method<void(cvflann::AutotunedIndex<Distance>::*)(cvflann::ResultSet<typename cvflann::AutotunedIndex<Distance>::DistanceType> &, const cvflann::AutotunedIndex<Distance>::ElementType *, const cvflann::SearchParams &)>("find_neighbors", &cvflann::AutotunedIndex<Distance>::findNeighbors,
