...
void Init_Flann_Dist()
{
  ...
  rb_mCvflann.define_module_function<int(*)(int)>("abs", static_cast<int(*)(int)>(&cvflann::abs),
    Arg("x"));

  rb_mCvflann.define_module_function<float(*)(float)>("abs", static_cast<float(*)(float)>(&cvflann::abs),
    Arg("x"));

  rb_mCvflann.define_module_function<double(*)(double)>("abs", static_cast<double(*)(double)>(&cvflann::abs),
    Arg("x"));

  rb_mCvflann.define_module_function<unsigned int(*)(float)>("round", static_cast<unsigned int(*)(float)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<unsigned short(*)(float)>("round", static_cast<unsigned short(*)(float)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<unsigned char(*)(float)>("round", static_cast<unsigned char(*)(float)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<long long(*)(float)>("round", static_cast<long long(*)(float)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<long(*)(float)>("round", static_cast<long(*)(float)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<int(*)(float)>("round", static_cast<int(*)(float)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<short(*)(float)>("round", static_cast<short(*)(float)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<char(*)(float)>("round", static_cast<char(*)(float)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<unsigned int(*)(double)>("round", static_cast<unsigned int(*)(double)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<unsigned short(*)(double)>("round", static_cast<unsigned short(*)(double)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<unsigned char(*)(double)>("round", static_cast<unsigned char(*)(double)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<long long(*)(double)>("round", static_cast<long long(*)(double)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<long(*)(double)>("round", static_cast<long(*)(double)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<int(*)(double)>("round", static_cast<int(*)(double)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<short(*)(double)>("round", static_cast<short(*)(double)>(&cvflann::round),
    Arg("x"));

  rb_mCvflann.define_module_function<char(*)(double)>("round", static_cast<char(*)(double)>(&cvflann::round),
    Arg("x"));
