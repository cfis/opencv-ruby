...
inline Rice::Data_Type<cvflann::Index<Distance>> Index_instantiate(Rice::Module parent, const char* name)
{
  return Rice::define_class_under<cvflann::Index<Distance>, cvflann::NNIndex<Distance>>(parent, name)
    ...
    .template define_method<void(cvflann::Index<Distance>::*)(cvflann::ResultSet<typename cvflann::Index<Distance>::DistanceType> &, const cvflann::Index<Distance>::ElementType *, const cvflann::SearchParams &)>("find_neighbors", &cvflann::Index<Distance>::findNeighbors,
