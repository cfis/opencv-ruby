...
{
  return Rice::define_class_under<cvflann::LinearIndex<Distance>, cvflann::NNIndex<Distance>>(parent, name)
    .define_constructor(Constructor<cvflann::LinearIndex<Distance>, const cvflann::Matrix<typename cvflann::LinearIndex<Distance>::ElementType> &, const cvflann::IndexParams &, Distance>(),
    ...
    .template define_method<void(cvflann::LinearIndex<Distance>::*)(FILE *)>("load_index", &cvflann::LinearIndex<Distance>::loadIndex,
      Arg("arg_0"))
    .template define_method<void(cvflann::LinearIndex<Distance>::*)(cvflann::ResultSet<typename cvflann::LinearIndex<Distance>::DistanceType> &, const cvflann::LinearIndex<Distance>::ElementType *, const cvflann::SearchParams &)>("find_neighbors", &cvflann::LinearIndex<Distance>::findNeighbors,
