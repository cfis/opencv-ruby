...
inline Rice::Data_Type<cvflann::NNIndex<Distance>> NNIndex_instantiate(Rice::Module parent, const char* name)
{
  return Rice::define_class_under<cvflann::NNIndex<Distance>>(parent, name).
    ...
    template define_method<void(cvflann::NNIndex<Distance>::*)(const cvflann::Matrix<typename cvflann::NNIndex<Distance>::ElementType>&, cvflann::Matrix<int>&, cvflann::Matrix<typename cvflann::NNIndex<Distance>::DistanceType>&, int, const cvflann::SearchParams&)>("knn_search", &cvflann::NNIndex<Distance>::knnSearch,
      Arg("queries"), Arg("indices"), Arg("dists"), Arg("knn"), Arg("params")).
    template define_method<int(cvflann::NNIndex<Distance>::*)(const cvflann::Matrix<typename cvflann::NNIndex<Distance>::ElementType>&, cvflann::Matrix<int>&, cvflann::Matrix<typename cvflann::NNIndex<Distance>::DistanceType>&, float, const cvflann::SearchParams&)>("radius_search", &cvflann::NNIndex<Distance>::radiusSearch,
