...
void Init_Flann_Params()
{
  ...
  rb_mCvflann.define_module_function<void(*)(const cvflann::IndexParams &, std::ostream &)>("print_params", static_cast<void(*)(const cvflann::IndexParams &, std::ostream &)>(&cvflann::print_params),
    Arg("params"), Arg("stream"));

  rb_mCvflann.define_module_function<void(*)(const cvflann::IndexParams &)>("print_params", static_cast<void(*)(const cvflann::IndexParams &)>(&cvflann::print_params),
    Arg("params"));
}
