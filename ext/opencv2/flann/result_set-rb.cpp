...
inline void BranchStruct_builder(Data_Type_T& klass)
{
  klass.define_attr("node", &cvflann::BranchStruct<T, DistanceType>::node).
    ...
    define_constructor(Constructor<cvflann::BranchStruct<T, DistanceType>, const T&, DistanceType>(),
      Arg("a_node"), Arg("dist")).
    define_method("<", &cvflann::BranchStruct<T, DistanceType>::operator<,
      Arg("rhs"));
};
...
{
  klass.define_method("full?", &cvflann::ResultSet<DistanceType>::full).
    define_method("add_point", &cvflann::ResultSet<DistanceType>::addPoint,
      Arg("dist"), Arg("index")).
    define_method("worst_dist", &cvflann::ResultSet<DistanceType>::worstDist);
};
...
inline void KNNSimpleResultSet_builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cvflann::KNNSimpleResultSet<DistanceType>, int>(),
    ...
    define_method("add_point", &cvflann::KNNSimpleResultSet<DistanceType>::addPoint,
      Arg("dist"), Arg("index")).
    define_method("worst_dist", &cvflann::KNNSimpleResultSet<DistanceType>::worstDist);
};
...
inline void KNNResultSet_builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cvflann::KNNResultSet<DistanceType>, int>(),
    ...
    define_method("add_point", &cvflann::KNNResultSet<DistanceType>::addPoint,
      Arg("dist"), Arg("index")).
    define_method("worst_dist", &cvflann::KNNResultSet<DistanceType>::worstDist);
};
...
inline void RadiusResultSet_builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cvflann::RadiusResultSet<DistanceType>, DistanceType, int*, DistanceType*, int>(),
    ...
    define_method("add_point", &cvflann::RadiusResultSet<DistanceType>::addPoint,
      Arg("dist"), Arg("index")).
    define_method("worst_dist", &cvflann::RadiusResultSet<DistanceType>::worstDist);
};
...
inline void KNNUniqueResultSet_builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cvflann::KNNUniqueResultSet<DistanceType>, unsigned int>(),
      Arg("capacity")).
    define_method("add_point", &cvflann::KNNUniqueResultSet<DistanceType>::addPoint,
      Arg("dist"), Arg("index")).
    define_method("clear", &cvflann::KNNUniqueResultSet<DistanceType>::clear);
};
...
inline void RadiusUniqueResultSet_builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cvflann::RadiusUniqueResultSet<DistanceType>, DistanceType>(),
      Arg("radius")).
    define_method("add_point", &cvflann::RadiusUniqueResultSet<DistanceType>::addPoint,
      Arg("dist"), Arg("index")).
    define_method("clear", &cvflann::RadiusUniqueResultSet<DistanceType>::clear).
    define_method("full?", &cvflann::RadiusUniqueResultSet<DistanceType>::full).
    define_method("worst_dist", &cvflann::RadiusUniqueResultSet<DistanceType>::worstDist);
};
