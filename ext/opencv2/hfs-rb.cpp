...
void Init_Hfs()
{
  ...
  Rice::Data_Type<cv::hfs::HfsSegment> rb_cCvHfsHfsSegment = define_class_under<cv::hfs::HfsSegment, cv::Algorithm>(rb_mCvHfs, "HfsSegment").
    ...
    define_method<cv::Mat(cv::hfs::HfsSegment::*)(cv::InputArray, bool)>("perform_segment_gpu", &cv::hfs::HfsSegment::performSegmentGpu,
      Arg("src"), Arg("if_draw") = static_cast<bool>(true)).
    define_method<cv::Mat(cv::hfs::HfsSegment::*)(cv::InputArray, bool)>("perform_segment_cpu", &cv::hfs::HfsSegment::performSegmentCpu,
      Arg("src"), Arg("if_draw") = static_cast<bool>(true)).
