...
void Init_Ml()
{
  ...
  Rice::Data_Type<cv::ml::EM> rb_cCvMlEM = define_class_under<cv::ml::EM, cv::ml::StatModel>(rb_mCvMl, "Em")
    ...
    .define_constant("START_M_STEP", (int)cv::ml::EM::START_M_STEP)
    .define_constant("START_AUTO_STEP", (int)cv::ml::EM::START_AUTO_STEP);
  ...
  Rice::Data_Type<cv::ml::ANN_MLP> rb_cCvMlANNMLP = define_class_under<cv::ml::ANN_MLP, cv::ml::StatModel>(rb_mCvMl, "AnnMlp")
