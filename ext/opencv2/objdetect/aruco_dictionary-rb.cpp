...
void Init_Objdetect_ArucoDictionary()
{
  Module rb_mCv = define_module("Cv");

  Module rb_mCvAruco = define_module_under(rb_mCv, "Aruco");

  Rice::Data_Type<cv::aruco::Dictionary> rb_cCvArucoDictionary = define_class_under<cv::aruco::Dictionary>(rb_mCvAruco, "Dictionary").
