...
void Init_Objdetect_CharucoDetector()
{
  Module rb_mCv = define_module("Cv");

  Module rb_mCvAruco = define_module_under(rb_mCv, "Aruco");

  Rice::Data_Type<cv::aruco::CharucoParameters> rb_cCvArucoCharucoParameters = define_class_under<cv::aruco::CharucoParameters>(rb_mCvAruco, "CharucoParameters").
