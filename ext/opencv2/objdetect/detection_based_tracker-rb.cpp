...
void Init_DetectionBasedTracker()
{
  ...
  rb_cCvDetectionBasedTrackerIDetector = define_class_under<cv::DetectionBasedTracker::IDetector>(rb_mCv, "IDetector").
  ...
  rb_cCvDetectionBasedTrackerParameters = define_class_under<cv::DetectionBasedTracker::Parameters>(rb_mCv, "Parameters").
  ...
  rb_cCvDetectionBasedTrackerExtObject = define_class_under<cv::DetectionBasedTracker::ExtObject>(rb_mCv, "ExtObject").
