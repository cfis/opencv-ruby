...
void Init_Objdetect_Face()
{
  ...
  Rice::Data_Type<cv::FaceDetectorYN> rb_cCvFaceDetectorYN = define_class_under<cv::FaceDetectorYN>(rb_mCv, "FaceDetectorYN")
    ...
    .define_method<int(cv::FaceDetectorYN::*)(cv::InputArray, cv::OutputArray)>("detect", &cv::FaceDetectorYN::detect,
      Arg("image"), Arg("faces"))
    .define_singleton_function<cv::Ptr<cv::FaceDetectorYN>(*)(const cv::String &, const cv::String &, const cv::Size &, float, float, int, int, int)>("create", static_cast<cv::Ptr<cv::FaceDetectorYN>(*)(const cv::String &, const cv::String &, const cv::Size &, float, float, int, int, int)>(&cv::FaceDetectorYN::create),
    ...
    .define_singleton_function<cv::Ptr<cv::FaceDetectorYN>(*)(const cv::String &, const std::vector<uchar> &, const std::vector<uchar> &, const cv::Size &, float, float, int, int, int)>("create", static_cast<cv::Ptr<cv::FaceDetectorYN>(*)(const cv::String &, const std::vector<uchar> &, const std::vector<uchar> &, const cv::Size &, float, float, int, int, int)>(&cv::FaceDetectorYN::create),
  ...
  Rice::Data_Type<cv::FaceRecognizerSF> rb_cCvFaceRecognizerSF = define_class_under<cv::FaceRecognizerSF>(rb_mCv, "FaceRecognizerSF")
    ...
    .define_singleton_function<cv::Ptr<cv::FaceRecognizerSF>(*)(const cv::String &, const cv::String &, int, int)>("create", static_cast<cv::Ptr<cv::FaceRecognizerSF>(*)(const cv::String &, const cv::String &, int, int)>(&cv::FaceRecognizerSF::create),
      Arg("model"), Arg("config"), Arg("backend_id") = static_cast<int>(0), Arg("target_id") = static_cast<int>(0))
    .define_singleton_function<cv::Ptr<cv::FaceRecognizerSF>(*)(const cv::String &, const std::vector<uchar> &, const std::vector<uchar> &, int, int)>("create", static_cast<cv::Ptr<cv::FaceRecognizerSF>(*)(const cv::String &, const std::vector<uchar> &, const std::vector<uchar> &, int, int)>(&cv::FaceRecognizerSF::create),
