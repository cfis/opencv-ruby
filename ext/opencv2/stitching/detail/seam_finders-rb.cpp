...
Rice::Data_Type<cv::detail::DpSeamFinder> rb_cCvDetailDpSeamFinder;
Rice::Data_Type<cv::detail::GraphCutSeamFinder> rb_cCvDetailGraphCutSeamFinder;
Rice::Data_Type<cv::detail::GraphCutSeamFinderBase> rb_cCvDetailGraphCutSeamFinderBase;
Rice::Data_Type<cv::detail::NoSeamFinder> rb_cCvDetailNoSeamFinder;
Rice::Data_Type<cv::detail::PairwiseSeamFinder> rb_cCvDetailPairwiseSeamFinder;
Rice::Data_Type<cv::detail::SeamFinder> rb_cCvDetailSeamFinder;
Rice::Data_Type<cv::detail::VoronoiSeamFinder> rb_cCvDetailVoronoiSeamFinder;
