...
void Init_Tracking()
{
  ...
  Rice::Data_Type<cv::TrackerCSRT> rb_cCvTrackerCSRT = define_class_under<cv::TrackerCSRT, cv::Tracker>(rb_mCvTracking, "TrackerCSRT").
    define_method("set_initial_mask", &cv::tracking::TrackerCSRT::setInitialMask,
      Arg("mask")).
    define_singleton_function("create", &cv::tracking::TrackerCSRT::create,
  ...
  Rice::Data_Type<cv::TrackerKCF> rb_cCvTrackerKCF = define_class_under<cv::TrackerKCF, cv::Tracker>(rb_mCvTracking, "TrackerKCF").
    define_method("set_feature_extractor", &cv::tracking::TrackerKCF::setFeatureExtractor,
      Arg("callback"), Arg("pca_func") = static_cast<bool>(false)).
    define_singleton_function("create", &cv::tracking::TrackerKCF::create,
