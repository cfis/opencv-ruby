...
void Init_Tracking_TrackingByMatching()
{
  ...
  Module rb_mCvDetailTrackingTbm = define_module_under(rb_mCvDetail, "Tbm");
  ...
  Rice::Data_Type<cv::detail::tbm::Track> rb_cCvDetailTbmTrack = define_class_under<cv::detail::tbm::Track>(rb_mCvDetailTrackingTbm, "Track")
    .define_constructor(Constructor<cv::detail::tracking::tbm::Track, const cv::detail::tbm::TrackedObjects &, const cv::Mat &, const cv::Mat &, const cv::Mat &>(),
    ...
    .define_method<const cv::detail::tbm::TrackedObject &(cv::detail::tracking::tbm::Track::*)(size_t) const>("[]", &cv::detail::tracking::tbm::Track::operator[],
      Arg("i"))
    .define_method<cv::detail::tbm::TrackedObject &(cv::detail::tracking::tbm::Track::*)(size_t)>("[]", &cv::detail::tracking::tbm::Track::operator[],
      Arg("i"))
    .define_method("[]=", [](cv::detail::tracking::tbm::Track&self, size_t i, cv::detail::tbm::TrackedObject & value)
    {
        self[i] = value;
    })
  ...
  Rice::Data_Type<cv::detail::tbm::ITrackerByMatching> rb_cCvDetailTbmITrackerByMatching = define_class_under<cv::detail::tbm::ITrackerByMatching>(rb_mCvDetailTrackingTbm, "ITrackerByMatching")
    .define_method<void(cv::detail::tracking::tbm::ITrackerByMatching::*)(const cv::Mat &, const cv::detail::tbm::TrackedObjects &, uint64_t)>("process", &cv::detail::tracking::tbm::ITrackerByMatching::process,
    ...
    .define_method<void(cv::detail::tracking::tbm::ITrackerByMatching::*)(const cv::detail::tbm::TrackerParams &)>("set_params", &cv::detail::tracking::tbm::ITrackerByMatching::setParams,
      Arg("params"))
    .define_method<const cv::detail::tbm::ITrackerByMatching::Descriptor &(cv::detail::tracking::tbm::ITrackerByMatching::*)() const>("descriptor_fast", &cv::detail::tracking::tbm::ITrackerByMatching::descriptorFast)
    .define_method<void(cv::detail::tracking::tbm::ITrackerByMatching::*)(const cv::detail::tbm::ITrackerByMatching::Descriptor &)>("set_descriptor_fast", &cv::detail::tracking::tbm::ITrackerByMatching::setDescriptorFast,
      Arg("val"))
    .define_method<const cv::detail::tbm::ITrackerByMatching::Descriptor &(cv::detail::tracking::tbm::ITrackerByMatching::*)() const>("descriptor_strong", &cv::detail::tracking::tbm::ITrackerByMatching::descriptorStrong)
    .define_method<void(cv::detail::tracking::tbm::ITrackerByMatching::*)(const cv::detail::tbm::ITrackerByMatching::Descriptor &)>("set_descriptor_strong", &cv::detail::tracking::tbm::ITrackerByMatching::setDescriptorStrong,
      Arg("val"))
    .define_method<const cv::detail::tbm::ITrackerByMatching::Distance &(cv::detail::tracking::tbm::ITrackerByMatching::*)() const>("distance_fast", &cv::detail::tracking::tbm::ITrackerByMatching::distanceFast)
    .define_method<void(cv::detail::tracking::tbm::ITrackerByMatching::*)(const cv::detail::tbm::ITrackerByMatching::Distance &)>("set_distance_fast", &cv::detail::tracking::tbm::ITrackerByMatching::setDistanceFast,
      Arg("val"))
    .define_method<const cv::detail::tbm::ITrackerByMatching::Distance &(cv::detail::tracking::tbm::ITrackerByMatching::*)() const>("distance_strong", &cv::detail::tracking::tbm::ITrackerByMatching::distanceStrong)
    .define_method<void(cv::detail::tracking::tbm::ITrackerByMatching::*)(const cv::detail::tbm::ITrackerByMatching::Distance &)>("set_distance_strong", &cv::detail::tracking::tbm::ITrackerByMatching::setDistanceStrong,
      Arg("val"))
    ...
    .define_method<cv::detail::tbm::TrackedObjects(cv::detail::tracking::tbm::ITrackerByMatching::*)() const>("tracked_detections", &cv::detail::tracking::tbm::ITrackerByMatching::trackedDetections)
  ...
  rb_mCvDetailTrackingTbm.define_module_function<cv::Ptr<cv::detail::tbm::ITrackerByMatching>(*)(const cv::detail::tbm::TrackerParams &)>("create_tracker_by_matching", &cv::detail::tracking::tbm::createTrackerByMatching,
    Arg("params") = static_cast<const cv::detail::tbm::TrackerParams &>(cv::detail::tracking::tbm::TrackerParams()));
}
