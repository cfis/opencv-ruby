...
void Init_Video_Detail_TrackingDetail()
{
  ...
  Rice::Data_Type<cv::detail::TrackerFeature> rb_cCvDetailTrackerFeature = define_class_under<cv::detail::TrackerFeature>(rb_mCvDetail, "TrackerFeature")
  ...
  Rice::Data_Type<cv::detail::TrackerFeatureSet> rb_cCvDetailTrackerFeatureSet = define_class_under<cv::detail::TrackerFeatureSet>(rb_mCvDetail, "TrackerFeatureSet")
  ...
  Rice::Data_Type<cv::detail::TrackerSamplerAlgorithm> rb_cCvDetailTrackerSamplerAlgorithm = define_class_under<cv::detail::TrackerSamplerAlgorithm>(rb_mCvDetail, "TrackerSamplerAlgorithm")
  ...
  Rice::Data_Type<cv::detail::TrackerSampler> rb_cCvDetailTrackerSampler = define_class_under<cv::detail::TrackerSampler>(rb_mCvDetail, "TrackerSampler")
  ...
  Rice::Data_Type<cv::detail::TrackerTargetState> rb_cCvDetailTrackerTargetState = define_class_under<cv::detail::TrackerTargetState>(rb_mCvDetail, "TrackerTargetState")
  ...
  Rice::Data_Type<cv::detail::TrackerStateEstimator> rb_cCvDetailTrackerStateEstimator = define_class_under<cv::detail::TrackerStateEstimator>(rb_mCvDetail, "TrackerStateEstimator")
    .define_method<cv::Ptr<cv::detail::TrackerTargetState>(cv::detail::tracking::TrackerStateEstimator::*)(const std::vector<cv::detail::ConfidenceMap> &)>("estimate", &cv::detail::tracking::TrackerStateEstimator::estimate,
      Arg("confidence_maps"))
    .define_method<void(cv::detail::tracking::TrackerStateEstimator::*)(std::vector<cv::detail::ConfidenceMap> &)>("update", &cv::detail::tracking::TrackerStateEstimator::update,
      Arg("confidence_maps"))
  ...
  Rice::Data_Type<cv::detail::TrackerModel> rb_cCvDetailTrackerModel = define_class_under<cv::detail::TrackerModel>(rb_mCvDetail, "TrackerModel")
    ...
    .define_method<const std::vector<cv::detail::ConfidenceMap> &(cv::detail::tracking::TrackerModel::*)() const>("get_confidence_maps", &cv::detail::tracking::TrackerModel::getConfidenceMaps)
    .define_method<const cv::detail::ConfidenceMap &(cv::detail::tracking::TrackerModel::*)() const>("get_last_confidence_map", &cv::detail::tracking::TrackerModel::getLastConfidenceMap)
