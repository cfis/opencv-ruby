...
void Init_Videostab_OpticalFlow()
{
  ...
  Rice::Data_Type<cv::videostab::SparsePyrLkOptFlowEstimator> rb_cCvVideostabSparsePyrLkOptFlowEstimator = define_class_under<cv::videostab::SparsePyrLkOptFlowEstimator, cv::videostab::ISparseOptFlowEstimator>(rb_mCvVideostab, "SparsePyrLkOptFlowEstimator")
  ...
  Rice::Data_Type<cv::videostab::SparsePyrLkOptFlowEstimatorGpu> rb_cCvVideostabSparsePyrLkOptFlowEstimatorGpu = define_class_under<cv::videostab::SparsePyrLkOptFlowEstimatorGpu, cv::videostab::ISparseOptFlowEstimator>(rb_mCvVideostab, "SparsePyrLkOptFlowEstimatorGpu")
  ...
  Rice::Data_Type<cv::videostab::DensePyrLkOptFlowEstimatorGpu> rb_cCvVideostabDensePyrLkOptFlowEstimatorGpu = define_class_under<cv::videostab::DensePyrLkOptFlowEstimatorGpu, cv::videostab::IDenseOptFlowEstimator>(rb_mCvVideostab, "DensePyrLkOptFlowEstimatorGpu")
