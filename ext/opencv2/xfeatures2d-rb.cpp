...
void Init_Xfeatures2d()
{
  ...
  Rice::Data_Type<cv::xfeatures2d::BoostDesc> rb_cCvXfeatures2dBoostDesc = define_class_under<cv::xfeatures2d::BoostDesc, cv::Feature2D>(rb_mCvXfeatures2d, "BoostDesc")
    ...
    .define_constant("BGM", (int)cv::xfeatures2d::BoostDesc::BGM)
    .define_constant("BGM_HARD", (int)cv::xfeatures2d::BoostDesc::BGM_HARD)
    .define_constant("BGM_BILINEAR", (int)cv::xfeatures2d::BoostDesc::BGM_BILINEAR)
