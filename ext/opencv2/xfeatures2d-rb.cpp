...
void Init_Xfeatures2d()
{
  ...
  Rice::Data_Type<cv::xfeatures2d::PCTSignatures> rb_cCvXfeatures2dPCTSignatures = define_class_under<cv::xfeatures2d::PCTSignatures, cv::Algorithm>(rb_mCvXfeatures2d, "PCTSignatures")
    .define_singleton_function<cv::Ptr<cv::xfeatures2d::PCTSignatures>(*)(const int, const int, const int)>("create", static_cast<cv::Ptr<cv::xfeatures2d::PCTSignatures>(*)(const int, const int, const int)>(&cv::xfeatures2d::PCTSignatures::create),
    ...
    .define_singleton_function<cv::Ptr<cv::xfeatures2d::PCTSignatures>(*)(const std::vector<cv::Point2f> &, const int)>("create", static_cast<cv::Ptr<cv::xfeatures2d::PCTSignatures>(*)(const std::vector<cv::Point2f> &, const int)>(&cv::xfeatures2d::PCTSignatures::create),
      Arg("init_sampling_points"), Arg("init_seed_count"))
    .define_singleton_function<cv::Ptr<cv::xfeatures2d::PCTSignatures>(*)(const std::vector<cv::Point2f> &, const std::vector<int> &)>("create", static_cast<cv::Ptr<cv::xfeatures2d::PCTSignatures>(*)(const std::vector<cv::Point2f> &, const std::vector<int> &)>(&cv::xfeatures2d::PCTSignatures::create),
  ...
  Rice::Data_Type<cv::xfeatures2d::AffineFeature2D> rb_cCvXfeatures2dAffineFeature2D = define_class_under<cv::xfeatures2d::AffineFeature2D, cv::Feature2D>(rb_mCvXfeatures2d, "AffineFeature2D")
    .define_singleton_function<cv::Ptr<cv::xfeatures2d::AffineFeature2D>(*)(cv::Ptr<cv::FeatureDetector>, cv::Ptr<cv::DescriptorExtractor>)>("create", static_cast<cv::Ptr<cv::xfeatures2d::AffineFeature2D>(*)(cv::Ptr<cv::FeatureDetector>, cv::Ptr<cv::DescriptorExtractor>)>(&cv::xfeatures2d::AffineFeature2D::create),
      Arg("keypoint_detector"), Arg("descriptor_extractor"))
    .define_singleton_function<cv::Ptr<cv::xfeatures2d::AffineFeature2D>(*)(cv::Ptr<cv::FeatureDetector>)>("create", static_cast<cv::Ptr<cv::xfeatures2d::AffineFeature2D>(*)(cv::Ptr<cv::FeatureDetector>)>(&cv::xfeatures2d::AffineFeature2D::create),
