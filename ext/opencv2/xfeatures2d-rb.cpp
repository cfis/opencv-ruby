...
void Init_Xfeatures2d()
{
  ...
  Rice::Data_Type<cv::xfeatures2d::FREAK> rb_cCvXfeatures2dFREAK = define_class_under<cv::xfeatures2d::FREAK, cv::Feature2D>(rb_mCvXfeatures2d, "FREAK").
    ...
    define_method("set_orientation_normalized", &cv::xfeatures2d::FREAK::setOrientationNormalized,
      Arg("orientation_normalized")).
    define_method("get_orientation_normalized?", &cv::xfeatures2d::FREAK::getOrientationNormalized).
    define_method("set_scale_normalized", &cv::xfeatures2d::FREAK::setScaleNormalized,
      Arg("scale_normalized")).
    define_method("get_scale_normalized?", &cv::xfeatures2d::FREAK::getScaleNormalized).
    define_method("set_pattern_scale", &cv::xfeatures2d::FREAK::setPatternScale,
      Arg("pattern_scale")).
    define_method("get_pattern_scale", &cv::xfeatures2d::FREAK::getPatternScale).
    define_method("set_n_octaves", &cv::xfeatures2d::FREAK::setNOctaves,
      Arg("n_octaves")).
    define_method("get_n_octaves", &cv::xfeatures2d::FREAK::getNOctaves).
    define_method("get_default_name", &cv::xfeatures2d::FREAK::getDefaultName).
    define_singleton_function("create", &cv::xfeatures2d::FREAK::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::StarDetector> rb_cCvXfeatures2dStarDetector = define_class_under<cv::xfeatures2d::StarDetector, cv::Feature2D>(rb_mCvXfeatures2d, "StarDetector").
    define_method("set_max_size", &cv::xfeatures2d::StarDetector::setMaxSize,
      Arg("_max_size")).
    define_method("get_max_size", &cv::xfeatures2d::StarDetector::getMaxSize).
    define_method("set_response_threshold", &cv::xfeatures2d::StarDetector::setResponseThreshold,
      Arg("_response_threshold")).
    define_method("get_response_threshold", &cv::xfeatures2d::StarDetector::getResponseThreshold).
    define_method("set_line_threshold_projected", &cv::xfeatures2d::StarDetector::setLineThresholdProjected,
      Arg("_line_threshold_projected")).
    define_method("get_line_threshold_projected", &cv::xfeatures2d::StarDetector::getLineThresholdProjected).
    define_method("set_line_threshold_binarized", &cv::xfeatures2d::StarDetector::setLineThresholdBinarized,
      Arg("_line_threshold_binarized")).
    define_method("get_line_threshold_binarized", &cv::xfeatures2d::StarDetector::getLineThresholdBinarized).
    define_method("set_suppress_nonmax_size", &cv::xfeatures2d::StarDetector::setSuppressNonmaxSize,
      Arg("_suppress_nonmax_size")).
    define_method("get_suppress_nonmax_size", &cv::xfeatures2d::StarDetector::getSuppressNonmaxSize).
    define_method("get_default_name", &cv::xfeatures2d::StarDetector::getDefaultName).
    define_singleton_function("create", &cv::xfeatures2d::StarDetector::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::BriefDescriptorExtractor> rb_cCvXfeatures2dBriefDescriptorExtractor = define_class_under<cv::xfeatures2d::BriefDescriptorExtractor, cv::Feature2D>(rb_mCvXfeatures2d, "BriefDescriptorExtractor").
    define_method("set_descriptor_size", &cv::xfeatures2d::BriefDescriptorExtractor::setDescriptorSize,
      Arg("bytes")).
    define_method("get_descriptor_size", &cv::xfeatures2d::BriefDescriptorExtractor::getDescriptorSize).
    define_method("set_use_orientation", &cv::xfeatures2d::BriefDescriptorExtractor::setUseOrientation,
      Arg("use_orientation")).
    define_method("get_use_orientation?", &cv::xfeatures2d::BriefDescriptorExtractor::getUseOrientation).
    define_method("get_default_name", &cv::xfeatures2d::BriefDescriptorExtractor::getDefaultName).
    define_singleton_function("create", &cv::xfeatures2d::BriefDescriptorExtractor::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::LUCID> rb_cCvXfeatures2dLUCID = define_class_under<cv::xfeatures2d::LUCID, cv::Feature2D>(rb_mCvXfeatures2d, "LUCID").
    define_method("set_lucid_kernel", &cv::xfeatures2d::LUCID::setLucidKernel,
      Arg("lucid_kernel")).
    define_method("get_lucid_kernel", &cv::xfeatures2d::LUCID::getLucidKernel).
    define_method("set_blur_kernel", &cv::xfeatures2d::LUCID::setBlurKernel,
      Arg("blur_kernel")).
    define_method("get_blur_kernel", &cv::xfeatures2d::LUCID::getBlurKernel).
    define_method("get_default_name", &cv::xfeatures2d::LUCID::getDefaultName).
    define_singleton_function("create", &cv::xfeatures2d::LUCID::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::LATCH> rb_cCvXfeatures2dLATCH = define_class_under<cv::xfeatures2d::LATCH, cv::Feature2D>(rb_mCvXfeatures2d, "LATCH").
    define_method("set_bytes", &cv::xfeatures2d::LATCH::setBytes,
      Arg("bytes")).
    define_method("get_bytes", &cv::xfeatures2d::LATCH::getBytes).
    define_method("set_rotation_invariance", &cv::xfeatures2d::LATCH::setRotationInvariance,
      Arg("rotation_invariance")).
    define_method("get_rotation_invariance?", &cv::xfeatures2d::LATCH::getRotationInvariance).
    define_method("set_half_ss_dsize", &cv::xfeatures2d::LATCH::setHalfSSDsize,
      Arg("half_ssd_size")).
    define_method("get_half_ss_dsize", &cv::xfeatures2d::LATCH::getHalfSSDsize).
    define_method("set_sigma", &cv::xfeatures2d::LATCH::setSigma,
      Arg("sigma")).
    define_method("get_sigma", &cv::xfeatures2d::LATCH::getSigma).
    define_method("get_default_name", &cv::xfeatures2d::LATCH::getDefaultName).
    define_singleton_function("create", &cv::xfeatures2d::LATCH::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::BEBLID> rb_cCvXfeatures2dBEBLID = define_class_under<cv::xfeatures2d::BEBLID, cv::Feature2D>(rb_mCvXfeatures2d, "BEBLID").
    define_method("set_scale_factor", &cv::xfeatures2d::BEBLID::setScaleFactor,
      Arg("scale_factor")).
    define_method("get_scale_factor", &cv::xfeatures2d::BEBLID::getScaleFactor).
    define_method("get_default_name", &cv::xfeatures2d::BEBLID::getDefaultName).
    define_singleton_function("create", &cv::xfeatures2d::BEBLID::create,
      Arg("scale_factor"), Arg("n_bits") = static_cast<int>(cv::xfeatures2d::BEBLID::SIZE_512_BITS));
  ...
  Rice::Data_Type<cv::xfeatures2d::TEBLID> rb_cCvXfeatures2dTEBLID = define_class_under<cv::xfeatures2d::TEBLID, cv::Feature2D>(rb_mCvXfeatures2d, "TEBLID").
    ...
    define_method("get_default_name", &cv::xfeatures2d::TEBLID::getDefaultName).
    define_singleton_function("create", &cv::xfeatures2d::TEBLID::create,
      Arg("scale_factor"), Arg("n_bits") = static_cast<int>(cv::xfeatures2d::TEBLID::SIZE_256_BITS));
  ...
  Rice::Data_Type<cv::xfeatures2d::DAISY> rb_cCvXfeatures2dDAISY = define_class_under<cv::xfeatures2d::DAISY, cv::Feature2D>(rb_mCvXfeatures2d, "DAISY").
    define_method("set_radius", &cv::xfeatures2d::DAISY::setRadius,
      Arg("radius")).
    define_method("get_radius", &cv::xfeatures2d::DAISY::getRadius).
    define_method("set_q_radius", &cv::xfeatures2d::DAISY::setQRadius,
      Arg("q_radius")).
    define_method("get_q_radius", &cv::xfeatures2d::DAISY::getQRadius).
    define_method("set_q_theta", &cv::xfeatures2d::DAISY::setQTheta,
      Arg("q_theta")).
    define_method("get_q_theta", &cv::xfeatures2d::DAISY::getQTheta).
    define_method("set_q_hist", &cv::xfeatures2d::DAISY::setQHist,
      Arg("q_hist")).
    define_method("get_q_hist", &cv::xfeatures2d::DAISY::getQHist).
    define_method("set_norm", &cv::xfeatures2d::DAISY::setNorm,
      Arg("norm")).
    define_method("get_norm", &cv::xfeatures2d::DAISY::getNorm).
    define_method("set_h", &cv::xfeatures2d::DAISY::setH,
      Arg("h")).
    define_method("get_h", &cv::xfeatures2d::DAISY::getH).
    define_method("set_interpolation", &cv::xfeatures2d::DAISY::setInterpolation,
      Arg("interpolation")).
    define_method("get_interpolation?", &cv::xfeatures2d::DAISY::getInterpolation).
    define_method("set_use_orientation", &cv::xfeatures2d::DAISY::setUseOrientation,
      Arg("use_orientation")).
    define_method("get_use_orientation?", &cv::xfeatures2d::DAISY::getUseOrientation).
    define_method("get_default_name", &cv::xfeatures2d::DAISY::getDefaultName).
    ...
    define_method<bool(cv::xfeatures2d::DAISY::*)(double, double, int, float*, double*) const>("get_unnormalized_descriptor", &cv::xfeatures2d::DAISY::GetUnnormalizedDescriptor,
      Arg("y"), Arg("x"), Arg("orientation"), ArgBuffer("descriptor"), ArgBuffer("h")).
    define_singleton_function("create", &cv::xfeatures2d::DAISY::create,
      Arg("radius") = static_cast<float>(15), Arg("q_radius") = static_cast<int>(3), Arg("q_theta") = static_cast<int>(8), Arg("q_hist") = static_cast<int>(8), Arg("norm") = static_cast<cv::xfeatures2d::DAISY::NormalizationType>(cv::xfeatures2d::DAISY::NRM_NONE), Arg("h") = static_cast<cv::InputArray>(cv::noArray()), Arg("interpolation") = static_cast<bool>(true), Arg("use_orientation") = static_cast<bool>(false));
  ...
  Rice::Data_Type<cv::xfeatures2d::MSDDetector> rb_cCvXfeatures2dMSDDetector = define_class_under<cv::xfeatures2d::MSDDetector, cv::Feature2D>(rb_mCvXfeatures2d, "MSDDetector").
    define_method("set_patch_radius", &cv::xfeatures2d::MSDDetector::setPatchRadius,
      Arg("patch_radius")).
    define_method("get_patch_radius", &cv::xfeatures2d::MSDDetector::getPatchRadius).
    define_method("set_search_area_radius", &cv::xfeatures2d::MSDDetector::setSearchAreaRadius,
      Arg("use_orientation")).
    define_method("get_search_area_radius", &cv::xfeatures2d::MSDDetector::getSearchAreaRadius).
    define_method("set_nms_radius", &cv::xfeatures2d::MSDDetector::setNmsRadius,
      Arg("nms_radius")).
    define_method("get_nms_radius", &cv::xfeatures2d::MSDDetector::getNmsRadius).
    define_method("set_nms_scale_radius", &cv::xfeatures2d::MSDDetector::setNmsScaleRadius,
      Arg("nms_scale_radius")).
    define_method("get_nms_scale_radius", &cv::xfeatures2d::MSDDetector::getNmsScaleRadius).
    define_method("set_th_saliency", &cv::xfeatures2d::MSDDetector::setThSaliency,
      Arg("th_saliency")).
    define_method("get_th_saliency", &cv::xfeatures2d::MSDDetector::getThSaliency).
    define_method("set_knn", &cv::xfeatures2d::MSDDetector::setKNN,
      Arg("k_nn")).
    define_method("get_knn", &cv::xfeatures2d::MSDDetector::getKNN).
    define_method("set_scale_factor", &cv::xfeatures2d::MSDDetector::setScaleFactor,
      Arg("scale_factor")).
    define_method("get_scale_factor", &cv::xfeatures2d::MSDDetector::getScaleFactor).
    define_method("set_n_scales", &cv::xfeatures2d::MSDDetector::setNScales,
      Arg("use_orientation")).
    define_method("get_n_scales", &cv::xfeatures2d::MSDDetector::getNScales).
    define_method("set_compute_orientation", &cv::xfeatures2d::MSDDetector::setComputeOrientation,
      Arg("compute_orientation")).
    define_method("get_compute_orientation?", &cv::xfeatures2d::MSDDetector::getComputeOrientation).
    define_method("get_default_name", &cv::xfeatures2d::MSDDetector::getDefaultName).
    define_singleton_function("create", &cv::xfeatures2d::MSDDetector::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::VGG> rb_cCvXfeatures2dVGG = define_class_under<cv::xfeatures2d::VGG, cv::Feature2D>(rb_mCvXfeatures2d, "VGG").
    define_method("get_default_name", &cv::xfeatures2d::VGG::getDefaultName).
    define_method("set_sigma", &cv::xfeatures2d::VGG::setSigma,
      Arg("isigma")).
    define_method("get_sigma", &cv::xfeatures2d::VGG::getSigma).
    define_method("set_use_normalize_image", &cv::xfeatures2d::VGG::setUseNormalizeImage,
      Arg("img_normalize")).
    define_method("get_use_normalize_image?", &cv::xfeatures2d::VGG::getUseNormalizeImage).
    define_method("set_use_scale_orientation", &cv::xfeatures2d::VGG::setUseScaleOrientation,
      Arg("use_scale_orientation")).
    define_method("get_use_scale_orientation?", &cv::xfeatures2d::VGG::getUseScaleOrientation).
    define_method("set_scale_factor", &cv::xfeatures2d::VGG::setScaleFactor,
      Arg("scale_factor")).
    define_method("get_scale_factor", &cv::xfeatures2d::VGG::getScaleFactor).
    define_method("set_use_normalize_descriptor", &cv::xfeatures2d::VGG::setUseNormalizeDescriptor,
      Arg("dsc_normalize")).
    define_method("get_use_normalize_descriptor?", &cv::xfeatures2d::VGG::getUseNormalizeDescriptor).
    define_singleton_function("create", &cv::xfeatures2d::VGG::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::BoostDesc> rb_cCvXfeatures2dBoostDesc = define_class_under<cv::xfeatures2d::BoostDesc, cv::Feature2D>(rb_mCvXfeatures2d, "BoostDesc").
    define_method("get_default_name", &cv::xfeatures2d::BoostDesc::getDefaultName).
    define_method("set_use_scale_orientation", &cv::xfeatures2d::BoostDesc::setUseScaleOrientation,
      Arg("use_scale_orientation")).
    define_method("get_use_scale_orientation?", &cv::xfeatures2d::BoostDesc::getUseScaleOrientation).
    define_method("set_scale_factor", &cv::xfeatures2d::BoostDesc::setScaleFactor,
      Arg("scale_factor")).
    define_method("get_scale_factor", &cv::xfeatures2d::BoostDesc::getScaleFactor).
    define_singleton_function("create", &cv::xfeatures2d::BoostDesc::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::PCTSignatures> rb_cCvXfeatures2dPCTSignatures = define_class_under<cv::xfeatures2d::PCTSignatures, cv::Algorithm>(rb_mCvXfeatures2d, "PCTSignatures").
    define_method("compute_signature", &cv::xfeatures2d::PCTSignatures::computeSignature,
      Arg("image"), Arg("signature")).
    define_method("compute_signatures", &cv::xfeatures2d::PCTSignatures::computeSignatures,
      Arg("images"), Arg("signatures")).
    define_method("get_sample_count", &cv::xfeatures2d::PCTSignatures::getSampleCount).
    define_method("get_grayscale_bits", &cv::xfeatures2d::PCTSignatures::getGrayscaleBits).
    define_method("set_grayscale_bits", &cv::xfeatures2d::PCTSignatures::setGrayscaleBits,
      Arg("grayscale_bits")).
    define_method("get_window_radius", &cv::xfeatures2d::PCTSignatures::getWindowRadius).
    define_method("set_window_radius", &cv::xfeatures2d::PCTSignatures::setWindowRadius,
      Arg("radius")).
    define_method("get_weight_x", &cv::xfeatures2d::PCTSignatures::getWeightX).
    define_method("set_weight_x", &cv::xfeatures2d::PCTSignatures::setWeightX,
      Arg("weight")).
    define_method("get_weight_y", &cv::xfeatures2d::PCTSignatures::getWeightY).
    define_method("set_weight_y", &cv::xfeatures2d::PCTSignatures::setWeightY,
      Arg("weight")).
    define_method("get_weight_l", &cv::xfeatures2d::PCTSignatures::getWeightL).
    define_method("set_weight_l", &cv::xfeatures2d::PCTSignatures::setWeightL,
      Arg("weight")).
    define_method("get_weight_a", &cv::xfeatures2d::PCTSignatures::getWeightA).
    define_method("set_weight_a", &cv::xfeatures2d::PCTSignatures::setWeightA,
      Arg("weight")).
    define_method("get_weight_b", &cv::xfeatures2d::PCTSignatures::getWeightB).
    define_method("set_weight_b", &cv::xfeatures2d::PCTSignatures::setWeightB,
      Arg("weight")).
    define_method("get_weight_contrast", &cv::xfeatures2d::PCTSignatures::getWeightContrast).
    define_method("set_weight_contrast", &cv::xfeatures2d::PCTSignatures::setWeightContrast,
      Arg("weight")).
    define_method("get_weight_entropy", &cv::xfeatures2d::PCTSignatures::getWeightEntropy).
    define_method("set_weight_entropy", &cv::xfeatures2d::PCTSignatures::setWeightEntropy,
      Arg("weight")).
    define_method("get_sampling_points", &cv::xfeatures2d::PCTSignatures::getSamplingPoints).
    define_method("set_weight", &cv::xfeatures2d::PCTSignatures::setWeight,
      Arg("idx"), Arg("value")).
    define_method("set_weights", &cv::xfeatures2d::PCTSignatures::setWeights,
      Arg("weights")).
    define_method("set_translation", &cv::xfeatures2d::PCTSignatures::setTranslation,
      Arg("idx"), Arg("value")).
    define_method("set_translations", &cv::xfeatures2d::PCTSignatures::setTranslations,
      Arg("translations")).
    define_method("set_sampling_points", &cv::xfeatures2d::PCTSignatures::setSamplingPoints,
      Arg("sampling_points")).
    define_method("get_init_seed_indexes", &cv::xfeatures2d::PCTSignatures::getInitSeedIndexes).
    define_method("set_init_seed_indexes", &cv::xfeatures2d::PCTSignatures::setInitSeedIndexes,
      Arg("init_seed_indexes")).
    define_method("get_init_seed_count", &cv::xfeatures2d::PCTSignatures::getInitSeedCount).
    define_method("get_iteration_count", &cv::xfeatures2d::PCTSignatures::getIterationCount).
    define_method("set_iteration_count", &cv::xfeatures2d::PCTSignatures::setIterationCount,
      Arg("iteration_count")).
    define_method("get_max_clusters_count", &cv::xfeatures2d::PCTSignatures::getMaxClustersCount).
    define_method("set_max_clusters_count", &cv::xfeatures2d::PCTSignatures::setMaxClustersCount,
      Arg("max_clusters_count")).
    define_method("get_cluster_min_size", &cv::xfeatures2d::PCTSignatures::getClusterMinSize).
    define_method("set_cluster_min_size", &cv::xfeatures2d::PCTSignatures::setClusterMinSize,
      Arg("cluster_min_size")).
    define_method("get_joining_distance", &cv::xfeatures2d::PCTSignatures::getJoiningDistance).
    define_method("set_joining_distance", &cv::xfeatures2d::PCTSignatures::setJoiningDistance,
      Arg("joining_distance")).
    define_method("get_drop_threshold", &cv::xfeatures2d::PCTSignatures::getDropThreshold).
    define_method("set_drop_threshold", &cv::xfeatures2d::PCTSignatures::setDropThreshold,
      Arg("drop_threshold")).
    define_method("get_distance_function", &cv::xfeatures2d::PCTSignatures::getDistanceFunction).
    define_method("set_distance_function", &cv::xfeatures2d::PCTSignatures::setDistanceFunction,
    ...
    define_singleton_function("draw_signature", &cv::xfeatures2d::PCTSignatures::drawSignature,
    ...
    define_singleton_function("generate_init_points", &cv::xfeatures2d::PCTSignatures::generateInitPoints,
  ...
  Rice::Data_Type<cv::xfeatures2d::PCTSignaturesSQFD> rb_cCvXfeatures2dPCTSignaturesSQFD = define_class_under<cv::xfeatures2d::PCTSignaturesSQFD, cv::Algorithm>(rb_mCvXfeatures2d, "PCTSignaturesSQFD").
    define_method("compute_quadratic_form_distance", &cv::xfeatures2d::PCTSignaturesSQFD::computeQuadraticFormDistance,
      Arg("_signature0"), Arg("_signature1")).
    define_method("compute_quadratic_form_distances", &cv::xfeatures2d::PCTSignaturesSQFD::computeQuadraticFormDistances,
      Arg("source_signature"), Arg("image_signatures"), Arg("distances")).
    define_singleton_function("create", &cv::xfeatures2d::PCTSignaturesSQFD::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::HarrisLaplaceFeatureDetector> rb_cCvXfeatures2dHarrisLaplaceFeatureDetector = define_class_under<cv::xfeatures2d::HarrisLaplaceFeatureDetector, cv::Feature2D>(rb_mCvXfeatures2d, "HarrisLaplaceFeatureDetector").
    define_method("set_num_octaves", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::setNumOctaves,
      Arg("num_octaves_")).
    define_method("get_num_octaves", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::getNumOctaves).
    define_method("set_corn_thresh", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::setCornThresh,
      Arg("corn_thresh_")).
    define_method("get_corn_thresh", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::getCornThresh).
    define_method("set_dog_thresh", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::setDOGThresh,
      Arg("dog_thresh_")).
    define_method("get_dog_thresh", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::getDOGThresh).
    define_method("set_max_corners", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::setMaxCorners,
      Arg("max_corners_")).
    define_method("get_max_corners", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::getMaxCorners).
    define_method("set_num_layers", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::setNumLayers,
      Arg("num_layers_")).
    define_method("get_num_layers", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::getNumLayers).
    define_method("get_default_name", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::getDefaultName).
    define_singleton_function("create", &cv::xfeatures2d::HarrisLaplaceFeatureDetector::create,
  ...
  Rice::Data_Type<cv::xfeatures2d::TBMR> rb_cCvXfeatures2dTBMR = define_class_under<cv::xfeatures2d::TBMR, cv::xfeatures2d::AffineFeature2D>(rb_mCvXfeatures2d, "TBMR").
    define_method("set_min_area", &cv::xfeatures2d::TBMR::setMinArea,
      Arg("min_area")).
    define_method("get_min_area", &cv::xfeatures2d::TBMR::getMinArea).
    define_method("set_max_area_relative", &cv::xfeatures2d::TBMR::setMaxAreaRelative,
      Arg("max_area")).
    define_method("get_max_area_relative", &cv::xfeatures2d::TBMR::getMaxAreaRelative).
    define_method("set_scale_factor", &cv::xfeatures2d::TBMR::setScaleFactor,
      Arg("scale_factor")).
    define_method("get_scale_factor", &cv::xfeatures2d::TBMR::getScaleFactor).
    define_method("set_n_scales", &cv::xfeatures2d::TBMR::setNScales,
      Arg("n_scales")).
  ...
  rb_mCvXfeatures2d.define_module_function("fast_for_point_set", &cv::xfeatures2d::FASTForPointSet,
    Arg("image"), Arg("keypoints"), Arg("threshold"), Arg("nonmax_suppression") = static_cast<bool>(true), Arg("type") = static_cast<cv::FastFeatureDetector::DetectorType>(cv::FastFeatureDetector::TYPE_9_16));

  rb_mCvXfeatures2d.define_module_function("match_gms", &cv::xfeatures2d::matchGMS,
  ...
  rb_mCvXfeatures2d.define_module_function("match_logos", &cv::xfeatures2d::matchLOGOS,
