...
void Init_Xphoto_Bm3dImageDenoising()
{
  ...
  rb_mCvXphoto.define_module_function<void(*)(cv::InputArray, cv::InputOutputArray, cv::OutputArray, float, int, int, int, int, int, int, float, int, int, int)>("bm3d_denoising", static_cast<void(*)(cv::InputArray, cv::InputOutputArray, cv::OutputArray, float, int, int, int, int, int, int, float, int, int, int)>(&cv::xphoto::bm3dDenoising),
  ...
  rb_mCvXphoto.define_module_function<void(*)(cv::InputArray, cv::OutputArray, float, int, int, int, int, int, int, float, int, int, int)>("bm3d_denoising", static_cast<void(*)(cv::InputArray, cv::OutputArray, float, int, int, int, int, int, int, float, int, int, int)>(&cv::xphoto::bm3dDenoising),
